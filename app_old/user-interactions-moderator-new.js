...
var Component = (function () {
    ...
    Component.prototype.validateIdField = function () {
        ...
        return function () { return _this.backEnd.getProjects().then(function (projects) { return projects.every(function (project) { return project.homers_id.indexOf(_this.idField) == -1; }); }); };
    };
    Component.prototype.onSubmit = function () {
        ...
        Promise.resolve(libBecki.getAdvancedField(this.projectField, this.projects.map(function (project) { return project.id; })) || this.backEnd.createDefaultProject().then(function (project) {
            ...
            return _this.backEnd.createHomer(_this.idField, _this.typeField, project);
        })
            .then(function () {
            _this.notifications.next.push(new libBeckiNotifications.Success("The moderator has been added."));
            _this.router.navigate(["/user/interactions/moderators"]);
        })
            .catch(function (reason) {
            _this.notifications.current.push(new libBeckiNotifications.Danger("The moderator cannot be added.", reason));
        });
    };
...
//# sourceMappingURL=user-interactions-moderator-new.js.map