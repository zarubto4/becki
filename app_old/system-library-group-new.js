...
var Component = (function () {
    ...
    Component.prototype.validateNameField = function () {
        ...
        return function () { return Promise.all([
            ...
            return !(_a = []).concat.apply(_a, groupsPages.map(function (page) { return page.content; })).find(function (group) { return group.group_name == _this.nameField; }) &&
...
//# sourceMappingURL=system-library-group-new.js.map