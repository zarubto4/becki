...
var Component = (function () {
    ...
    Component.prototype.validateNameField = function () {
        ...
        return function () { return _this.backEnd.getProducers().then(function (producers) { return !producers.find(function (producer) { return producer.name == _this.nameField; }); }); };
    };
    Component.prototype.onSubmit = function () {
        ...
        this.backEnd.createProducer(this.nameField, this.descriptionField)
            .then(function () {
            _this.notifications.next.push(new libBeckiNotifications.Success("The producer has been created."));
            _this.router.navigate(["/system"]);
        })
            .catch(function (reason) {
            _this.notifications.current.push(new libBeckiNotifications.Danger("The producer cannot be created.", reason));
        });
    };
...
//# sourceMappingURL=system-producer-new.js.map