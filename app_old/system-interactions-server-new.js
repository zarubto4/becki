...
var Component = (function () {
    ...
    Component.prototype.onSubmit = function () {
        ...
        this.backEnd.createCloudHomerServer(this.nameField)
            ...
            _this.notifications.current.push(new libBeckiNotifications.Warning("issue/TYRION-281"));
    ...
    Component.prototype.validateNameField = function () {
        ...
        return function () { return _this.backEnd.getCloudHomerServers().then(function (servers) { return !servers.find(function (servers) { return servers.server_name == _this.nameField; }); }); };
    };
...
//# sourceMappingURL=system-interactions-server-new.js.map