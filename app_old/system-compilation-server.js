...
var Component = (function () {
    ...
    Component.prototype.ngOnInit = function () {
        ...
        this.routeParamsSubscription = this.activatedRoute.params.subscribe(function (params) {
            ...
            _this.breadcrumbs.push(new libBeckiLayout.LabeledLink("Compilation Server", ["/system/compilation/servers", _this.serverId]));
        });
    };
    ...
    Component.prototype.onSubmit = function () {
        ...
        this.backEnd.editCompilationServer(this.serverId, this.nameField)
            ...
            _this.router.navigate(["/system/compilation/servers"]);
        })
...
//# sourceMappingURL=system-compilation-server.js.map