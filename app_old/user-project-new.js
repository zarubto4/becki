...
var Component = (function () {
    ...
    Component.prototype.validateNameField = function () {
        ...
        return function () { return _this.backEnd.getProjects().then(function (projects) { return !projects.find(function (project) { return project.project_name == _this.nameField; }); }); };
    };
    Component.prototype.onSubmit = function () {
        ...
        this.backEnd.createProject(this.nameField, this.descriptionField)
            .then(function () {
            _this.notifications.next.push(new libBeckiNotifications.Success("The project has been created."));
            _this.router.navigate(["/user/projects"]);
        })
            .catch(function (reason) {
            _this.notifications.current.push(new libBeckiNotifications.Danger("The project cannot be created.", reason));
        });
    };
...
//# sourceMappingURL=user-project-new.js.map