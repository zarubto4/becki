...
var Component = (function () {
    ...
    Component.prototype.validateNameField = function () {
        ...
        return function () { return _this.backEnd.getProcessors().then(function (processors) { return !processors.find(function (processor) { return processor.processor_name == _this.nameField; }); }); };
    };
    Component.prototype.onSubmit = function () {
        ...
        this.backEnd.createProcessor(this.nameField, this.codeField, this.descriptionField, this.speedField)
            .then(function () {
            _this.notifications.next.push(new libBeckiNotifications.Success("The processor has been created."));
            _this.router.navigate(["/system"]);
        })
            .catch(function (reason) {
            _this.notifications.current.push(new libBeckiNotifications.Danger("The processor cannot be created.", reason));
        });
    };
...
//# sourceMappingURL=system-processor-new.js.map