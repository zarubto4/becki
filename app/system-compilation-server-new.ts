...
export class Component implements ngCore.OnInit {
    ...
    onSubmit():void{
        ...
        this.backEnd.createCompilationServer(this.nameField)
            ...
            .catch(reason => {
                ...
                this.notifications.current.push(new libBeckiNotifications.Danger("issue/TYRION-268"));
    ...
    validateNameField():()=>Promise<boolean> {
        ...
        return () => this.backEnd.getCompilationServers().then(servers => !servers.find(servers => servers.server_name == this.nameField));
    }
}