/**
 * Created by davidhradek on 31.10.16.
 */
...
export class StaticOptionLists {
    ...
    public static countryList: BeckiFormSelectOption[] = [  //TODO tento seznam prý neodpovídá ISO normě
        {
            data: false,
            label: "Afghanistan",
            value: "Afghanistan"
    ...
    public static ISOcountryList: any[] = [{
        "name": "Afghanistan",
        "alpha-2": "AF",
        "alpha-3": "AFG",
        "country-code": "004",
