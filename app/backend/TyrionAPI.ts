...
/*                                                            */
/*   Build date: 2016-09-08 18:13:45                          */
 ...
 * @description: Interface INotificationElement definition
 */
...
export abstract class TyrionAPI {
     ...
     * @throws [code 500] Server side Error
     */
    public editCProgramBinary(board_id:string):Promise<IResultOk> {
        return this.requestRestPath("POST", `/compilation/c_program/binary/${board_id}`, {}, [200]);
    }
