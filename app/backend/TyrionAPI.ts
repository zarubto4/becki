...
/*                                                            */
/*   Build date: 2016-09-20 18:17:12                          */
...
export interface IBlockoBlockNew {
    ...
    name: string;
    /**
     * @name new_type_of_block
     * @type boolean
     * @description Must be true, if user want his BlockoBlock in new TypeOfBlock group.
     * @required
     */
    new_type_of_block: boolean;
    /**
     * @name project_id
     * @type string
     * @description 
     ...
     * @name type_of_block_id
     * @type string
     * @description Can be null, if user do not know, admin will decide which type
     */
    type_of_block_id?: string;
    /**
     * @name type_of_block_name
...
export abstract class TyrionAPI {
     ...
     *
     */
    public createNotificationTest(mail:string):Promise<IResult> {
        return this.requestRestPath("POST", `/notification/test/${mail}`, {}, [200]);
    }
    ...
    /**
     * @name putBlockoApproveWithChanges
     ...
     *
     */
    public putBlockoApproveWithChanges():Promise<IResult> {
        return this.requestRestPath("PUT", `/project/blocko/approve_with_changes`, {}, [200]);
    }
