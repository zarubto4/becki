...
/*                                                            */
/*   Build date: 2016-10-10 12:49:32                          */
...
export interface IBlockoBlockNew {
    ...
    project_id?: string;
    /**
     * @name type_of_block_general_description
     * @type string
     * @description Can be null, if type exists. Required if 'new_type_of_block' = true. Length must be between 24 and 255 characters.
     */
    type_of_block_general_description?: string;
    /**
     * @name type_of_block_id
     * @type string
     ...
     * @name type_of_block_name
     * @type string
     * @description Can be null, if type exists. Required if 'new_type_of_block' = true. Length must be between 8 and 60 characters.
     */
    type_of_block_name?: string;
    /**
     * @name version_description
