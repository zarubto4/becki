...
/*                                                            */
/*   Build date: 2016-11-15 16:14:34                          */
/*   Tyrion version: 1.06.7                                   */
/*                                                            */
...
/**
 * @name IProductDetail
 * @description: Interface IProductDetail definition
 */
...
/**
 * @name IProductsAllApplicable
 * @description: Json Model for new Producer
 */
export interface IProductsAllApplicable {
    /**
     * @name list
     * @type IProductDetail[]
     */
...
export abstract class TyrionAPI {
     ...
     *
     *
     * @returns {IProductsAllApplicable} [code 200] Ok Result
     *
     * @throws {IBadRequest} [code 400] Something is wrong - details in message 
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws [code 500] Server side Error
     */
    public getAllProductUserApplicables():Promise<IProductsAllApplicable> {
     ...
     * @throws [code 500] Server side Error
     */
    public getInstanceProject(project_id:string):Promise<IHomerInstance[]> {
    ...
    /**
     * @name getMProgramAppUrl
     * @summary get url + m_program code for Terminal
     * @operationId get_conection_url
     * @tags APP-Api
     *
     * @param {string} instance_id
     * @param {string} m_program_id
     * @param {string} version_object_id
     *
     ...
     * @throws [code 500] Server side Error
     */
    public getMProgramAppUrl(instance_id:string, m_program_id:string, version_object_id:string):Promise<IMProgramVersion> {
        return this.requestRestPath("GET", `/m_program/app/url/${instance_id}/${m_program_id}/${version_object_id}`, {}, [200]);
    }
