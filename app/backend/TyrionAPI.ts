...
/*                                                            */
/*   Build date: 2016-12-05 10:48:33                          */
/*   Tyrion version: 1.07.2                                   */
/*                                                            */
...
/**
 * @name ITypeOfWidgetLight
 * @description: Type_Of_Widget Light (only few properties)
 */
export interface ITypeOfWidgetLight {
    /**
     * @name type_of_widget_description
     * @type string
     * @readonly
     * @required
     */
    type_of_widget_description: string;
    /**
     * @name type_of_widget_id
     * @type string
     * @readonly
...
export interface ITypeOfWidgetList {
    /**
     * @name content
     * @type ITypeOfWidgetLight[]
     * @readonly
     * @required
     */
    content: ITypeOfWidgetLight[];
    /**
     * @name from
     * @type number
     * @description First value position from all subjects. Minimum is 0.
...
export abstract class TyrionAPI {
     ...
     * @tags Grid-Widget
     *
     * @description update basic information (name, and desription) of the independent GridWidget
     *
     * @param {string} grid_widget_id - grid_widget_id String path
     * @param {IGridWidgetNew} body - Contains Json with values
     *
