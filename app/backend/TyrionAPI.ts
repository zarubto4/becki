...
/*                                                            */
/*   Build date: 2016-10-26 18:28:09                          */
/*   Tyrion version: 1.06.6.6                                 */
/*                                                            */
...
/**
 * @name ICProgramVersionLight
 * @description: Json Model for Public Version of C_program
 */
export interface ICProgramVersionLight {
    /**
     * @name version_description
     * @type string
     * @readonly
...
export interface ICProgramVersionPublicList {
    /**
     * @name content
     * @type ICProgramVersionLight[]
     * @readonly
     * @required
     */
    content: ICProgramVersionLight[];
    /**
     * @name from
     * @type number
     * @description First value position from all subjects. Minimum is 0.
...
export interface IMProgram {
    ...
    /**
     * @name program_versions
     * @type IMProgramVersion[]
     * @readonly
     * @required
     */
    program_versions: IMProgramVersion[];
    /**
     * @name qr_token
     * @type string
     * @required
...
export interface IMProgramNew {
     ...
     * @name screen_size_type_id
     * @type string
     * @description Required valid screen_size_type_id
     * @required
     */
    screen_size_type_id: string;
}
...
export interface IObjectDetail {
     ...
     * @name description
     * @type string
     * @description Description of object for users
     * @required
     */
    description: string;
    /**
...
export interface ITariffLabel {
     ...
     * @name icon
     * @type string
     * @description icon code - AwesomeFont library
     * @readonly
     * @required
     */
    icon: string;
...
export interface ITariffRegister {
     ...
     * @name payment_method
     * @type string
     * @description Required: only in if required_payment_mode is true  values =>[bank_transfer, credit_card]
     * @required
     */
    payment_method: string;
    /**
...
export abstract class TyrionAPI {
     ...
     * @throws [code 500] Server side Error
     */
    public confirmNotification(notification_id:string):Promise<IResultOk> {
    ...
    public createMProgramVersion(m_program_id:string, body:ISwaggerMProgramVersionNew):Promise<IMProgramVersion> {
        return this.requestRestPath("POST", `/m_program_version/${m_program_id}`, body, [201]);
    }
    ...
    public createScreenType(body:IScreeSizeTypeNew):Promise<IScreenSizeType[]> {
        return this.requestRestPath("POST", `/screen_type`, body, [201]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public deleteMProgramVersion(m_program_id:string):Promise<IResultOk|IResult> {
        return this.requestRestPath("DELETE", `/m_program_version/${m_program_id}`, {}, [200,201]);
    }
    ...
    public deleteScreenType(screen_size_type_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/screen_type/${screen_size_type_id}`, {}, [200]);
    }
     ...
     * @operationId update_blocko_code_in_instance_version
    ...
    /**
     * @name editBlockoBlockSchemeVersion
     * @operationId edit_BlockoBlock_Version_scheme
     * @tags Not Documented API - InProgress or Stuck
     *
     *
     * @returns {IResult} [code 200] successful operation
     *
     */
    public editBlockoBlockSchemeVersion():Promise<IResult> {
        return this.requestRestPath("PUT", `/project/blockoBlock/scheme/version`, {}, [200]);
    }

    /**
     * @name editBlockoBlockVersion
     * @summary edit BlockoBlock version
     * @operationId edit_BlockoBlock_Version
     * @tags Blocko-Block
     *
    ...
    public editBlockoBlockVersion(blocko_block_version_id:string, body:IBlockoBlockBlockoVersionEdit):Promise<IBlockoBlockVersion> {
        return this.requestRestPath("PUT", `/project/blockoBlock/version/${blocko_block_version_id}`, body, [200]);
    }
    ...
    public editScreenType(screen_size_type_id:string, body:IScreeSizeTypeNew):Promise<IScreenSizeType> {
        return this.requestRestPath("PUT", `/screen_type/${screen_size_type_id}`, body, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public editTarifDetails(payment_details_id:number, body:ITariffDetailsEdit):Promise<IPaymentDetails> {
     ...
     * @operationId get_BlockoBlock_Version_scheme
     * @tags Not Documented API - InProgress or Stuck
     *
     *
     * @returns {IResult} [code 200] successful operation
    ...
    public getAllBlockoBlockSchemeVersions():Promise<IResult> {
        return this.requestRestPath("GET", `/project/blockoBlock/scheme/version`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public getAllMProgramAppPrograms():Promise<IMProgram[]> {
        return this.requestRestPath("GET", `/m_program/app/m_programs`, {}, [200]);
    }

    /**
     * @name getAllMProjectPersons
     ...
     * @throws [code 500] Server side Error
     */
    public getAllMProjectPersons():Promise<IMProject[]> {
        return this.requestRestPath("GET", `/m_project/person`, {}, [200]);
    }
    ...
    public getAllScreenTypes():Promise<IScreenSizeTypeCombination> {
        return this.requestRestPath("GET", `/screen_type/all`, {}, [200]);
    }
     ...
     *
     */
    public getNotificationTest(mail:string):Promise<IResult> {
        return this.requestRestPath("GET", `/notification/test/${mail}`, {}, [200]);
    }
    ...
    public getScreenType(screen_size_type_id:string):Promise<IScreenSizeType> {
        return this.requestRestPath("GET", `/screen_type/${screen_size_type_id}`, {}, [200]);
    }
    ...
    /**
     * @name putBProgramInstancePing
     * @operationId ping_instance
     * @tags Not Documented API - InProgress or Stuck
     *
     * @param {string} instance_id
     *
     ...
     *
     */
    public putBProgramInstancePing(instance_id:string):Promise<IResult> {
        return this.requestRestPath("PUT", `/project/b_program/instance/ping/${instance_id}`, {}, [200]);
    }

    /**
     * @name putBProgramInstanceShutDown
     ...
     *
     */
    public putBProgramInstanceShutDown(instance_id:string):Promise<IResult> {
        return this.requestRestPath("PUT", `/project/b_program/instance/shut_down/${instance_id}`, {}, [200]);
    }
    ...
    public putBlockoApproval():Promise<IResult> {
        return this.requestRestPath("PUT", `/project/blocko/approval`, {}, [200]);
    }

    /**
     * @name putBlockoBlockVersionMakePublic
     * @summary make BlockoBlock version public
     * @operationId make_BlockoBlock_Version_public
     * @tags Blocko-Block
     *
    ...
    public putBlockoBlockVersionMakePublic(blocko_block_version_id:string):Promise<IBlockoBlockVersion> {
        return this.requestRestPath("PUT", `/project/blockoBlock/version/make_public/${blocko_block_version_id}`, {}, [200]);
    }
    ...
    public putBlockoDisapprove():Promise<IResult> {
        return this.requestRestPath("PUT", `/project/blocko/disapprove`, {}, [200]);
    }

    /**
     * @name putCProgramVersionApproval
     * @operationId changeApprovalState
     * @tags Not Documented API - InProgress or Stuck
     *
     *
     * @returns {IResult} [code 200] successful operation
     *
     */
    public putCProgramVersionApproval():Promise<IResult> {
        return this.requestRestPath("PUT", `/compilation/c_program/version/approval`, {}, [200]);
    }

    /**
     * @name putCProgramVersionApproveWithChanges
     * @operationId approveWithChanges
     * @tags Not Documented API - InProgress or Stuck
     *
     *
     * @returns {IResult} [code 200] successful operation
     *
     */
    public putCProgramVersionApproveWithChanges():Promise<IResult> {
        return this.requestRestPath("PUT", `/compilation/c_program/version/approve_with_changes`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public uploadBProgramToCloud(version_id:string, body:IBProgramUploadInstance):Promise<IHomerInstance> {
        return this.requestRestPath("PUT", `/project/b_program/uploadToCloud/${version_id}`, body, [200]);
    }
