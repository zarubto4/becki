...
/*                                                            */
/*   Build date: 2016-10-31 19:19:21                          */
...
export interface IBProgramState {
     ...
     * @name instance_id
     * @type string
     * @description Id of Instance - independent object
     * @readonly
     * @required
     */
    instance_id: string;
     ...
     * @name version_id
     * @type string
     * @description Id of B_Program version whitch is running on Homer Server
     * @readonly
     * @required
     */
    version_id: string;
...
export interface IHomerInstance {
     ...
     * @description Only if instance is upload in Homer
     * @readonly
     * @required
     */
...
export abstract class TyrionAPI {
    ...
    public connectHomer(project_id:string, homer_id:string):Promise<IProject> {
        return this.requestRestPath("PUT", `/homer/${project_id}/${homer_id}`, {}, [200]);
    }
    ...
    public createHomer(body:IHomerNew):Promise<IPrivateHomerServer> {
        return this.requestRestPath("POST", `/homer`, body, [201]);
    }
    ...
    public deleteHomer(homer_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/homer/${homer_id}`, {}, [200]);
    }
    ...
    public disconnectHomer(project_id:string, homer_id:string):Promise<IProject> {
        return this.requestRestPath("DELETE", `/homer/${project_id}/${homer_id}`, {}, [200]);
    }
    ...
    public getHomer(homer_id:string):Promise<IPrivateHomerServer> {
        return this.requestRestPath("GET", `/homer/${homer_id}`, {}, [200]);
    }
    ...
    public listHomers(page_number:number, body:IHomerFilter):Promise<IHomerList> {
        return this.requestRestPath("PUT", `/homer/filter/${page_number}`, body, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public uploadBProgramToCloud(version_id:string, body:IBProgramUploadInstance):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/b_program/uploadToCloud/${version_id}`, body, [200]);
    }
