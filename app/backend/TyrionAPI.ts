...
/*                                                            */
/*   Build date: 2017-01-03 16:01:56                          */
...
export interface ICloudHomerServer {
     ...
     * @name server_name
     * @type string
     * @description Unique name For Blocko cloud_blocko_server. Length must be between 6 and 60 characters
     * @required
     */
    server_name: string;
    /**
...
/**
 * @name ILibraryGroup
 * @description: Model of LibraryGroup
 */
...
/**
 * @name ISingleLibrary
 * @description: Model of SingleLibrary
 */
...
/**
 * @name ISwaggerBProgramVersionNew
 * @description: Json Model for new Version of B_Program
 */
export interface ISwaggerBProgramVersionNew {
    /**
     * @name hardware_group
...
export abstract class TyrionAPI {
     ...
     * @param {ISwaggerBProgramVersionNew} body - Contains Json with values
     *
     ...
     * @throws [code 500] Server side Error
     */
    public createBProgramVersion(b_program_id:string, body:ISwaggerBProgramVersionNew):Promise<IBProgramVersion> {
    ...
    /**
     * @name createCProgramVersionCompile
     ...
     * @throws [code 500] Server side Error
     */
    public createCProgramVersionCompile(body:ICProgramVersionUpdate):Promise<IResultOk> {
     ...
     */
    public createLogin(body:ILogin):Promise<ILoginToken> {
     ...
     * @throws [code 500] Server side Error
     */
    public createLogout():Promise<IResultOk> {
     ...
     * @throws [code 500] Server side Error
     */
    public getInvoicePdf(invoice_id:number):Promise<IInvoiceFullDetails> {
        return this.requestRestPath("GET", `/invoice/pdf/${invoice_id}`, {}, [200]);
    }
