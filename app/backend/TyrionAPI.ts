...
/*                                                            */
/*   Build date: 2016-11-24 13:42:38                          */
...
export interface IBProgram {
    ...
    /**
     * @name version_objects
     * @type IVersionObject[]
     */
    version_objects?: IVersionObject[];
}
...
export abstract class TyrionAPI {
    ...
    public deleteMProgramVersion(m_program_version_id:string):Promise<IResultOk|IResult> {
        return this.requestRestPath("DELETE", `/m_program_version/${m_program_version_id}`, {}, [200,201]);
    }
     ...
     *
     * @param {string} notification_id - notification_id String path
     * @param {string} action - action String path
     *
     * @returns {IResultOk} [code 200] Ok Result
     *
     * @throws {IObjectNotFound} [code 400] Objects not found
     ...
     * @throws [code 500] Server side Error
     */
    public putNotificationConfirm(notification_id:string, action:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/notification/confirm/${notification_id}/${action}`, {}, [200]);
    }
