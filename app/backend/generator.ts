...
var CONFIG = {
    ...
    methodsReplace: {
        ...
        "put:/project/b_program/update/{b_program_id}": "createBProgramVersion",
        "put:/project/b_program/uploadToCloud/{version_id}": "uploadBProgramToCloud",
        "put:/project/b_program/uploadToHomer/{b_program_id}/{version_id}/{homer_id}": "uploadBProgramToHomer",
        "put:/project/project/addParticipant/{invitation_id}/{decision}": "addProjectParticipant",
        "put:/project/project/shareProject/{project_id}": "shareProject",
        "put:/project/project/unshareProject/{project_id}": "unshareProject",
