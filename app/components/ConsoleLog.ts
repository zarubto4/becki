        ...
        if (error instanceof SafeMachineError) {
            ...
            if (error.position) {
                if (error.position.lineA == error.position.lineB) {
                    posInfo = "<br><strong>Position:</strong> line <strong>" + error.position.lineA + "</strong> column <strong>" + error.position.columnA + "</strong> - <strong>" + error.position.columnB + "</strong>";
                } else {
                    posInfo = "<br><strong>Position:</strong> line <strong>" + error.position.lineA + "</strong> column <strong>" + error.position.columnA + "</strong> - line <strong>" + error.position.lineB + "</strong> column <strong>" + error.position.columnB + "</strong>";
                }
            }
