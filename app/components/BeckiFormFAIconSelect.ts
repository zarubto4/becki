...
export class BeckiFormFAIconSelect {
    ...
    ngOnInit(): void {
        ...
        if (this.readonly) {
            throw Error("Readonly is not support now in component BeckiFormFAIconSelect!")
        }

        this.iconSelectOptions = [];
        var usedIcons:string[] = [];
        for (var key in BeckiFormFAIconSelect.FontAwesomeMap) {
            var fa:string = (<any>BeckiFormFAIconSelect.FontAwesomeMap)[key];
