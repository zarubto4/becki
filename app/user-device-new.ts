...
export class Component implements ng.OnInit {
  ...
  onSubmit():void {
    ...
    Promise.resolve(
        ...
        .then(() => {
          this.notifications.next.push(new notifications.Success("The device has been added."));
          this.router.navigate(["UserDevices"]);
        })
        .catch(reason => {
          this.notifications.current.push(new notifications.Danger("The device cannot be added.", reason));
        });
  }
