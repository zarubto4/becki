...
@ng.Component({
  templateUrl: "app/interactions-scheme-version.html",
...
export class Component implements ng.OnInit {
  ...
  constructor(routeParams:ngRouter.RouteParams, backEndService:backEnd.Service, notifications:libPatternFlyNotifications.Service, router:ngRouter.Router) {
    ...
    this.breadcrumbs = [
      ...
      new layout.LabeledLink("Versions", ["InteractionsScheme", {scheme: this.schemeId}]),
      new layout.LabeledLink("Loading...", ["InteractionsSchemeVersion", {scheme: this.schemeId, version: this.id}])
    ];
  ...
  onInit():void {
    ...
    this.backEnd.getInteractionsScheme(this.schemeId)
        ...
        .then(result => {
          ...
          this.breadcrumbs[4].label = version.version_name;
