    ...
    public static translate: { [lang: string]: { [keyOrEnv: string]: (string | { [key: string]: string }) } } = {
        'en': {
            ...
            'ForgotPasswordComponent': {
                ...
                'label_no_instance_history_comment': 'Each <strong class="font-color-blocko">BLOCKO</strong> program and versions which are paired with <strong class="font-color-hardware">HARDWARE</strong> are stored as a separate Snap Shots.',
            ...
            'BlockoViewComponent': {
                ...
                'title': 'Updates',
                'label_waiting_update_procedure': 'Planed Update',
                'label_required_version': 'Required Version',
