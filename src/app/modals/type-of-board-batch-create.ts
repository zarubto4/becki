...
export class ModalsCreateHardwareTypeBatchComponent implements OnInit {
    ...
    constructor(private backendService: TyrionBackendService, private formBuilder: FormBuilder) {
        ...
        this.form = this.formBuilder.group({
            ...
            'mac_address_start': [ 0, [Validators.required, Validators.minLength(9), Validators.maxLength(15), BeckiValidators.number]],
            'mac_address_end': [ 0, [Validators.required, Validators.minLength(9), Validators.maxLength(15), BeckiValidators.number]],
