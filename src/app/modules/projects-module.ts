...
export const PROJECTS_ROUTES: Routes = [
    ...
    { path: ':project/release-update', data: { breadName: 'Actualization Procedures' }, loadChildren: './project-actualization-procedure-module#ProjectActualizationProcedureModule' },
