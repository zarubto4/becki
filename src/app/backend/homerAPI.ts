...
/*                                                            */
/*   Build date: 2018-01-17 11:23:58                          */
/*   Homer  version: 1.13.32                                  */
/*                                                            */
...
export interface IHomerServerPublicDetail {
    ...
    edit_permission: boolean;
    /**
     * @name hardware_log_port
     * @type number
     * @format int32
     * @readonly
     * @required
     */
    hardware_log_port: number;
    /**
     * @name id
     * @type string
     * @readonly
...
export abstract class HomerAPI {
    ...
    public bProgramGetFile(b_program_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer_server/file/b_program/${b_program_version_id}`, {}, [200]);
    }
    ...
    public bootloaderGetFile(bootloader_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer_server/file/bootloader/${bootloader_version_id}`, {}, [200]);
    }
    ...
    /**
     * @name requestCheckToken
     * @summary check Request Token
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public requestCheckToken(body:IBlockoTokenValidationRequest):Promise<IBlockoTokenValidationResult> {
        return this.requestRestPath("POST", `/secure/rest_api_token_validation`, body, [200]);
    }
     ...
     * @param {IGridTerminalIdentf} body - Contains Json with values
     *
     * @returns {IGridTerminal} [code 200] Valid Identification
     *
     * @throws {IResultBadRequest} [code 400] Invalid Identification
     * @throws [code 500] Server side Error
     */
    public terminalCheck(terminal_id:string, body:IGridTerminalIdentf):Promise<IGridTerminal> {
        return this.requestRestPath("PUT", `/websocket/terminal/identificator/${terminal_id}`, body, [200]);
    }
     ...
     * @param {IGridTerminalIdentf} body - Contains Json with values
     *
     * @returns {IGridTerminal} [code 201] Successfully created
     *
     * @throws {IInvalidBody} [code 400] Some Json value Missing
     * @throws [code 500] Server side Error
     */
    public terminalGet(body:IGridTerminalIdentf):Promise<IGridTerminal> {
        return this.requestRestPath("PUT", `/websocket/terminal/identificator`, body, [201]);
    }
