...
/*                                                            */
/*   Build date: 2017-06-27 10:39:35                          */
/*   Tyrion version: 1.12.0                                   */
/*                                                            */
...
export abstract class TyrionAPI {
     ...
     *
     */
    public deleteAdminBoard(board_id:string):Promise<IResult> {
        return this.requestRestPath("DELETE", `/admin/board/${board_id}`, {}, [200]);
    }
