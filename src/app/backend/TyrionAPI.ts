...
/*                                                            */
/*   Build date: 2017-10-22 22:32:08                          */
/*   Tyrion version: 1.13.5                                   */
/*                                                            */
...
export interface ICompilationLibrary {
    ...
    published_at: string;
    /**
     * @name release_desription
     * @type string
     */
    release_desription?: string;
    /**
     * @name tag_name
     * @type string
     * @example v1.0.1
...
export abstract class TyrionAPI {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public reportBug(bug_id:string, body:IBugReport):Promise<IServerError> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public serverUpdateServerComponent():Promise<IResultOk> {
        return this.requestRestPath("POST", `/admin/update`, {}, [200]);
    }
