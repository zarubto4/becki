...
/*                                                            */
/*   Build date: 2017-04-26 10:43:23                          */
/*   Tyrion version: 1.09.1                                   */
/*                                                            */
...
export interface IProductNew {
    ...
    /**
     * @name payment_mode
     * @type ("free"|"monthly"|"annual"|"per_credit")
     * @description Required: only in if payment_mode_required is true
     */
    payment_mode?: ("free"|"monthly"|"annual"|"per_credit");
    /**
...
export interface IProject {
    ...
    edit_permission: boolean;
    /**
     * @name financial_permission
     * @type boolean
     * @readonly
     * @required
     */
    financial_permission: boolean;
    /**
     * @name id
     * @type string
     */
...
export abstract class TyrionAPI {
     ...
     *
     * @returns {IInvoice|IProduct} [code 200|201] Created successfully - payment is required|Created successfully - payment not required
     *
     * @throws {IBadRequest} [code 400] Something is wrong
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public createProduct(body:IProductNew):Promise<IInvoice|IProduct> {
     ...
     * @tags Price & Invoice & Tariffs
     *
     * @description Extension is used to somehow(based on config and type) extend product capabilities. (e.g. how many projects can user have)
     *
