...
/*                                                            */
/*   Build date: 2018-06-25 18:43:07                          */
/*   Tyrion version: 2.2.5                                    */
/*                                                            */
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public instanceAddMeshNetworkKey(instance_id:string, body:IInstanceToken):Promise<IInstanceSnapshot> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public instanceUpdateMeshNetworkKey(instance_id:string, token:string, body:IInstanceToken):Promise<IInstanceSnapshot> {
