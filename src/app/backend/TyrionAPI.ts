...
/*                                                            */
/*   Build date: 2017-07-04 16:35:03                          */
...
export abstract class TyrionAPI {
    ...
    /**
     * @name getCloudHomerServerFileBProgram
     ...
     * @throws [code 500] Server side Error
     */
    public getCloudHomerServerFileBProgram(b_program_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer_server/file/b_program/${b_program_version_id}`, {}, [200]);
    }

    /**
     * @name getCloudHomerServerFileBootloader
     ...
     * @throws [code 500] Server side Error
     */
    public getCloudHomerServerFileBootloader(bootloader_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer_server/file/bootloader/${bootloader_version_id}`, {}, [200]);
    }

    /**
     * @name getCloudHomerServerFileCProgram
     ...
     * @description Required secure Token changed throw websocket
     *
     * @param {string} c_program_version_id
     *
     * @returns {any} [code 200] 
     *
     * @throws [code 303] Ok Result
     ...
     * @throws [code 500] Server side Error
     */
    public getCloudHomerServerFileCProgram(c_program_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer_server/file/c_program/${c_program_version_id}`, {}, [200]);
    }
