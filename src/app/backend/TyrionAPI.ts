...
/*                                                            */
/*   Build date: 2018-03-13 10:01:04                          */
...
/**
 * @name IInterface
 * @description: Interface IInterface definition
 */
...
export interface IUpdateProcedure {
     ...
     * @required
     */
    instanceSnapShot: IInstanceSnapshot;
    /**
...
export abstract class TyrionAPI extends HomerAPI {
    ...
    /**
     * @name bProgramGetFile
     * @summary get B_Program File
     ...
     *
     * @param {string} b_program_version_id
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public bProgramGetFile(b_program_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer/file/b_program/${b_program_version_id}`, {}, [200]);
    }
    ...
    /**
     * @name bootloaderGetFile
     * @summary get Bootloader File
     * @operationId cloud_file_get_bootloader
     * @tags Homer-Server-API
     *
     * @description Required secure Token changed throw websocket
     *
     * @param {string} bootloader_version_id
     *
     * @returns {any} [code 200] 
     *
     * @throws [code 303] Automatic Redirect To another URL
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public bootloaderGetFile(bootloader_version_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer/file/bootloader/${bootloader_version_id}`, {}, [200]);
    }
    ...
    public cProgramGetFile(compilation_id:string):Promise<any> {
        return this.requestRestPath("GET", `/cloud/homer/file/c_program/${compilation_id}`, {}, [200]);
    }
    ...
    /**
     * @name widgetGetByFilter
     * @summary get Widget by Filter
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public widgetGetByFilter(page_number:number, body:IGridWidgetFilter):Promise<IGridWidgetList> {
