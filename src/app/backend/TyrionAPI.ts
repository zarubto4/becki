...
/*                                                            */
/*   Build date: 2018-05-14 17:10:52                          */
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public articleEdit(article_id:string, body:string):Promise<IBProgram> {
    ...
    /**
     * @name gSMGetListByFilter
     * @summary get GSM List by filter
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gSMGetListByFilter(page_number:number, body:IGSMFilter):Promise<IGSMList> {
    ...
    /**
     * @name homerServerDownload
     * @summary download Homer_Server
     * @operationId homer_server_download
     * @tags External-Server
     *
     * @param {string} type
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public homerServerDownload(type:string):Promise<IResultOk> {
        return this.requestRestPath("GET", `/homer_server/download/${type}`, {}, [200]);
    }
    ...
    public simDelete(sim_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/gsm/${sim_id}`, {}, [200]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public simRegister(body:string):Promise<IGSM> {
