...
/*                                                            */
/*   Build date: 2017-08-18 12:37:49                          */
...
export interface IBProgramState {
     ...
     * @required
     */
    server_online_state: ("not_yet_first_connected"|"synchronization_in_progress"|"offline"|"online"|"unknown_lost_connection_with_server");
    /**
...
export abstract class TyrionAPI {
    ...
    /**
     * @name forOnlyTyrionFrontEnd
     * @summary only for Tyrion Front End
     * @operationId c_program_get_version_for_decision
     ...
     *
     */
    public forOnlyTyrionFrontEnd(version_id:string):Promise<IResult> {
        return this.requestRestPath("GET", `/c_program/version_for_decision/${version_id}`, {}, [200]);
    }
     ...
     *
     *
     * @returns {IHomerServerPublicDetail[]} [code 200] Ok Result
     *
     * @throws {IForbidden} [code 403] Need required permission
     * @throws [code 500] Server side Error
     */
    public homerServersGetList():Promise<IHomerServerPublicDetail[]> {
