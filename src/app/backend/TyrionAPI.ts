...
/*                                                            */
/*   Build date: 2017-08-29 18:36:49                          */
...
export abstract class TyrionAPI {
    ...
    public tariffExtensionActive(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/tariff_extension/active/${extension_id}`, {}, [200]);
    }
    ...
    public tariffExtensionCreate(tariff_id:string, body:ITariffExtensionNew):Promise<IProductExtension> {
        return this.requestRestPath("POST", `/tariff_extension/${tariff_id}`, body, [201]);
    }
    ...
    public tariffExtensionDeactivate(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/tariff_extension/deactive/${extension_id}`, {}, [200]);
    }
    ...
    public tariffExtensionDelete(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/tariff_extension/${extension_id}`, {}, [200]);
    }
    ...
    public tariffExtensionEdit(extension_id:string, body:ITariffExtensionEdit):Promise<IProductExtension> {
        return this.requestRestPath("PUT", `/tariff_extension/${extension_id}`, body, [200]);
    }
    ...
    public tariffExtensionOrderDown(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/tariff_extension/down/${extension_id}`, {}, [200]);
    }
    ...
    public tariffExtensionOrderUP(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/tariff_extension/up/${extension_id}`, {}, [200]);
    }
