...
/*                                                            */
/*   Build date: 2017-04-19 15:59:51                          */
/*   Tyrion version: 1.07.9                                   */
/*                                                            */
...
export interface IBoardSetBackup {
     ...
     * @required
     */
    board_backup_pair_list: IConnectedBoardIN[];
}
...
export abstract class TyrionAPI {
    ...
    /**
     * @name getAllSecureRestApiTokenValidations
     * @summary check Request Token for blocko REST-API blocks
     * @operationId get_status_request_token
     * @tags Blocko
     *
     * @param {IBlockoTokenValidationRequest} body - Contains Json with values
     *
     * @returns {IBlockoTokenValidationResult} [code 200] Ok Result
     *
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws [code 500] Server side Error
     */
    public getAllSecureRestApiTokenValidations(body:IBlockoTokenValidationRequest):Promise<IBlockoTokenValidationResult> {
        return this.requestRestPath("GET", `/secure/rest_api_token_validation`, body, [200]);
    }
     ...
     *
     * @description For connection to websocket, you have to connect with temporary unique token. This Api return Token with a maximum lifetime of 5 seconds. After the token is deactivated. After logging in, or the connection lost is token deactivated also. 
     *
     *
