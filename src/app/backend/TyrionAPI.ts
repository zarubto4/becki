...
/*                                                            */
/*   Build date: 2017-05-15 18:16:51                          */
/*   Tyrion version: 1.08.2.04                                */
/*                                                            */
...
export interface IProductExtension {
    ...
    /**
     * @name type
     * @type ("Project"|"Log"|"Database"|"RestApi")
     * @required
     */
    type: ("Project"|"Log"|"Database"|"RestApi");
}
...
export abstract class TyrionAPI {
     ...
     *
     * @returns {IResult|IResultOk} [code 200|201] successful operation|Successful created
     *
     * @throws {IJsonValueMissingResult} [code 400] Some Json value Missing
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws [code 500] Server side Error
     */
    public updateBootloader(body:IBoardBootloaderUpdate):Promise<IResult|IResultOk> {
