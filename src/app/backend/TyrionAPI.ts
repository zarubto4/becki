...
/*                                                            */
/*   Build date: 2017-02-06 17:16:40                          */
/*   Tyrion version: 1.07.5                                   */
/*                                                            */
...
export interface IBoardRegistrationStatus {
     ...
     * @name status
     * @type string
     * @description CAN_REGISTER, ALREADY_REGISTERED_YOUR_ACC, ALREADY_REGISTERED, PERMANENTLY_DISABLED, BROKEN_DEVICE
...
export interface IImportLibrary {
     ...
     * @type ICProgramVersionShortDetail[]
     */
    versions?: ICProgramVersionShortDetail[];
}


/**
 * @name IImportLibraryVersionNew
 * @description: Json Model for new Version of ImportLibrary
 */
export interface IImportLibraryVersionNew {
    /**
     * @name library_files
     * @type ILibraryFile[]
     */
...
export abstract class TyrionAPI {
    ...
    /**
     * @name createInvoiceReimbursement
     ...
     * @throws [code 500] Server side Error
     */
    public createInvoiceReimbursement(invoice_id:string):Promise<IGoPayUrl> {
        return this.requestRestPath("POST", `/invoice/reimbursement/${invoice_id}`, {}, [200]);
    }

    /**
     * @name createInvoiceResend
     ...
     * @throws [code 500] Server side Error
     */
    public createInvoiceResend(invoice_id:string):Promise<IResultOk> {
        return this.requestRestPath("POST", `/invoice/resend/${invoice_id}`, {}, [200]);
    }

    /**
     * @name createLibraryVersion
     * @summary new Version of ImportLibrary
     * @operationId importLibraryVersion_create
     * @tags ImportLibrary
     *
     * @description If you want add new code to ImportLibrary
     *
     * @param {string} library_id - library_id String query
     * @param {IImportLibraryVersionNew} body - Contains Json with values
     *
     * @returns {ICProgramVersionShortDetail} [code 201] Successfully created
     *
     * @throws {IBadRequest} [code 400] Something is wrong
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws [code 500] Server side Error
     */
    public createLibraryVersion(library_id:string, body:IImportLibraryVersionNew):Promise<ICProgramVersionShortDetail> {
     ...
     *
     * @returns {IGoPayUrl|IProduct} [code 200|201] Created successfully - but payment is required by Credit Card|Created successfully - payment not required
     *
     * @throws {IInvoice} [code 202] Created successfully - but payment is required by Bank Transfer
     * @throws {IBadRequest} [code 400] Something is wrong - details in message 
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws [code 500] Server side Error
     ...
     * @tags Board
     *
     * @description Check Board state for new Registration. Types of responses in JSON state value[CAN_REGISTER, NOT_EXIST, ALREADY_REGISTERED_YOUR_ACC, ALREADY_REGISTERED, PERMANENTLY_DISABLED, BROKEN_DEVICE]... 
     ...
     * @throws [code 500] Server side Error
     */
    public getBoardCheck(board_id:string):Promise<IBoardRegistrationStatus> {
        return this.requestRestPath("GET", `/board/check/${board_id}`, {}, [200]);
    }
     ...
     * @param {string} version_id - version_id String query
     *
     * @returns {ICProgramVersionShortDetail} [code 200] Ok Result
     *
     * @throws {IBadRequest} [code 400] Something is wrong
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws [code 500] Server side Error
     */
    public getLibraryVersion(version_id:string):Promise<ICProgramVersionShortDetail> {
    ...
    public uploadCProgramVersion(version_id:string, body:IListOfBoards):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/c_program/version/upload/${version_id}`, body, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public uploadPersonPicture():Promise<IResultOk> {
        return this.requestRestPath("PUT", `/person/picture/upload`, {}, [200]);
    }
