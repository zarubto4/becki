...
/*                                                            */
/*   Build date: 2019-01-31 18:06:40                          */
/*   Tyrion version: 2.3.2                                    */
/*                                                            */
...
export interface IBoardFilter {
    ...
    /**
     * @name order_by
     * @type ("NAME"|"FULL_ID"|"ID"|"DATE_OF_REGISTER")
     * @description Order By Enum value
     */
    order_by?: ("NAME"|"FULL_ID"|"ID"|"DATE_OF_REGISTER");
    /**
     * @name order_schema
     * @type ("ASC"|"DESC")
     * @description Order
...
/**
 * @name IDataSimCountryDataGram
 * @description: Value for parsing per country, only if its required by Filter
 */
export interface IDataSimCountryDataGram {
    /**
     * @name country
     * @type string
     ...
     * @required
     */
    data_consumption: number;
}


/**
 * @name IDataSimDataGram
 * @description: Json Model value of filtered values for GSM. Its represent DAY, HOUR, MONTH etc.
 */
export interface IDataSimDataGram {
    /**
     * @name data_consumption
     * @type number
     * @format int32
    ...
    data_consumption: number;
    /**
     * @name data_traffic_by_country
     * @type IDataSimCountryDataGram[]
     * @description List of Pairs with country name and data_consumption
     * @readonly
     * @required
     */
    data_traffic_by_country: IDataSimCountryDataGram[];
    /**
     * @name date_from
     * @type number
...
/**
 * @name IDataSimOverview
 * @description: Json Model with list of filtered values for GSM
 */
export interface IDataSimOverview {
    /**
     * @name datagram
     * @type IDataSimDataGram[]
     * @required
     */
    datagram: IDataSimDataGram[];
}
...
/**
 * @name IEONElectricityMetterList
 * @description: Json Model for EON
 */
export interface IEONElectricityMetterList {
    /**
     * @name content
     * @type IElectroMeters[]
     * @readonly
 ...
 * @description: Json Model for EON
 */
export interface IEONDataValue {
    /**
     * @name avg
     * @type number
     * @format double
 ...
 */
export interface IElectroMeters {
    /**
     * @name created
     * @type number
     * @description unixTime
...
export interface IGSM {
    ...
    /**
     * @name sim_tm_status
     * @type ITMSimRichStatus
     * @description If value is in -1 - its mean that we have no idea, probably missing traffic or error on partner server
     * @readonly
     */
    sim_tm_status?: ITMSimRichStatus;
    /**
     * @name sim_type
     * @type ("CARD"|"CHIP")
     * @required
...
export interface IGSMCDRList {
    /**
     * @name content
     * @type IModelMongoThingsMobileCRD[]
     * @readonly
     * @required
     */
    content: IModelMongoThingsMobileCRD[];
    /**
     * @name from
     * @type number
     * @description First value position from all subjects. Minimum is 0.
...
export interface IGitHubReleases {
    ...
    /**
     * @name author
     * @type ISwaggerGitHubAuthor
     * @required
     */
    author: ISwaggerGitHubAuthor;
    /**
     * @name body
     * @type string
     * @required
...
export interface IHardwareUpdateMake {
     ...
     * @type IHardwareUpdateMakeHardwareType[]
     * @readonly
     * @required
     */
    hardware_type_settings: IHardwareUpdateMakeHardwareType[];
    /**
     * @name name
     * @type string
     * @description Length must be between 2 and 60 characters.
...
/**
 * @name IHardwareUpdateMakeHardwareType
 * @description: Json Model for ActualizationProcedure Make Procedure - HardwareType
 */
export interface IHardwareUpdateMakeHardwareType {
    /**
     * @name bootloader_id
     * @type string
     * @format uuid
...
export interface IInstanceSnapshot {
     ...
     * @name link_to_download
     * @type string
     * @description File Link, only if snapshot is main
     * @readonly
     */
    link_to_download?: string;
    /**
...
/**
 * @name IModelMongoThingsMobileCRD
 * @description: Interface IModelMongoThingsMobileCRD definition
 */
export interface IModelMongoThingsMobileCRD {
    /**
     * @name cdr_country
     * @type string
     * @required
...
export interface INotificationButton {
    /**
     * @name action
     * @type ("ACCEPT_PROJECT_INVITATION"|"REJECT_PROJECT_INVITATION"|"CONFIRM_NOTIFICATION"|"ACCEPT_RESTORE_FIRMWARE"|"REJECT_RESTORE_FIRMWARE")
     * @required
     */
    action: ("ACCEPT_PROJECT_INVITATION"|"REJECT_PROJECT_INVITATION"|"CONFIRM_NOTIFICATION"|"ACCEPT_RESTORE_FIRMWARE"|"REJECT_RESTORE_FIRMWARE");
    /**
     * @name bold
     * @type boolean
     * @required
...
export interface IProjectValidUniqueName {
    ...
    /**
     * @name object_type
     * @type ("Project"|"HomerServer"|"CodeServer"|"BProgram"|"BProgramVersion"|"CProgram"|"CProgramVersion"|"CLibrary"|"CLibraryVersion"|"GridProgram"|"GridProgramVersion"|"GridProject"|"Hardware"|"HardwareGroup"|"GSM"|"Role"|"Widget"|"WidgetVersion"|"Block"|"BlockVersion"|"Instance"|"Snapshot"|"Database"|"DatabaseCollection")
     * @description Type
     * @required
     */
    object_type: ("Project"|"HomerServer"|"CodeServer"|"BProgram"|"BProgramVersion"|"CProgram"|"CProgramVersion"|"CLibrary"|"CLibraryVersion"|"GridProgram"|"GridProgramVersion"|"GridProject"|"Hardware"|"HardwareGroup"|"GSM"|"Role"|"Widget"|"WidgetVersion"|"Block"|"BlockVersion"|"Instance"|"Snapshot"|"Database"|"DatabaseCollection");
    /**
     * @name parent_id
     * @type string
...
/**
 * @name ISwaggerGitHubAuthor
 * @description: Interface ISwaggerGitHubAuthor definition
 */
export interface ISwaggerGitHubAuthor {
    /**
     * @name login
     * @type string
     * @required
...
/**
 * @name IUploadBin
 * @description: Json Model for upload Bin file to Hardware with Manual Update procedure
 */
export interface IUploadBin {
    /**
     * @name file
     * @type string
     * @description The file is encoded in base64. If it is null - it is a command to delete a file
...
export abstract class TyrionAPI extends HomerAPI {
    ...
    /**
     * @name andEditSaveGarfield
     * @summary edit and save Garfield
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public andEditSaveGarfield(garfield_id:string, body:IGarfieldEdit):Promise<IGarfield> {
    ...
    public apikeyAdd():Promise<ILoginToken> {
        return this.requestRestPath("POST", `/apikey`, {}, [200]);
    }
     ...
     * @tags B_Program
     *
     * @description Add Tag to Blocko Program
     *
     ...
     * @tags B_Program
     *
     * @description Remove Tag from Blocko program
     *
     * @param {ITags} body - Contains Json with values
     *
     * @returns {IBProgram} [code 200] Ok Result
    ...
    public blockClone(body:IBlockoBlockCopy):Promise<IBlock> {
        return this.requestRestPath("POST", `/block/clone`, body, [201]);
    }
     ...
     * @tags Block
     *
     * @description Remove Tag from Block
     *
     * @param {ITags} body - Contains Json with values
     *
     * @returns {IBlock} [code 200] Ok Result
    ...
    /**
     * @name cProgramUploadBinFile
     * @summary upload C_Program Bin File
     * @operationId uploadBinaryFileToBoard
     * @tags Actualization
     *
     * @description Upload manually build file on your own risk
     *
     * @param {IUploadBin} body - Contains Json with values
     *
     * @returns {IResultOk} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public cProgramUploadBinFile(body:IUploadBin):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/release_update/make_bin`, body, [200]);
    }
    ...
    public contactCreateCustomer(customer_id:string, body:IContactUpdate):Promise<IContact> {
        return this.requestRestPath("POST", `/customer/contact/${customer_id}`, body, [201]);
    }
    ...
    public contactEditDetails(contact_id:string, body:IContactUpdate):Promise<IContact> {
        return this.requestRestPath("PUT", `/contact/${contact_id}`, body, [200]);
    }
    ...
    public customerCreate(body:IContactUpdate):Promise<ICustomer> {
        return this.requestRestPath("POST", `/customer`, body, [201]);
    }
    ...
    public customersGetAll():Promise<ICustomer[]> {
        return this.requestRestPath("GET", `/customer`, {}, [200]);
    }
    ...
    public databaseCollectionCreate(db_id:string, collection_name:string):Promise<IProductExtension> {
        return this.requestRestPath("PUT", `/database/${db_id}/${collection_name}`, {}, [200]);
    }
    ...
    public databaseCollectionGet(db_id:string):Promise<IDatabase> {
        return this.requestRestPath("GET", `/database/${db_id}`, {}, [200]);
    }
    ...
    public databaseCreate(body:ISwaggerDatabaseNew):Promise<IDatabase> {
        return this.requestRestPath("POST", `/database`, body, [201]);
    }
    ...
    public databaseDelete(db_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/database/${db_id}`, {}, [200]);
    }
    ...
    public databaseEdit(db_id:string, body:INameAndDescription):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/database/${db_id}`, body, [200]);
    }
    ...
    public databasesGet(product_id:string):Promise<IDatabase[]> {
        return this.requestRestPath("GET", `/database/all/${product_id}`, {}, [200]);
    }
     ...
     * @summary create Electricity_Meter
     * @operationId create_electro_metters
     * @tags EON
     *
     * @description Create Electricity Meter
     *
     * @param {string} body - constraints for query
     *
     * @returns {IElectroMeters} [code 200] Ok Result
     *
     * @throws {IResultInvalidBody} [code 400] Invalid body
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public electricityMeterCreate(body:string):Promise<IElectroMeters> {
        return this.requestRestPath("POST", `/eon/electricity_meter`, body, [200]);
    }

    /**
     * @name electricityMeterDataGet
     * @summary get Electricity_Meter_Data
     * @operationId getValues
     * @tags EON
     *
     * @description values in given date range, from given hardware, averaged inside time intervals given in minutes
     *
     * @param {string} body - constraints for query
     *
     * @returns {IEONDataValue[]} [code 200] Ok Result
     *
     * @throws {IResultInvalidBody} [code 400] Invalid body
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public electricityMeterDataGet(body:string):Promise<IEONDataValue[]> {
        return this.requestRestPath("PUT", `/eon/grouped_values`, body, [200]);
    }

    /**
     * @name electricityMeterGetList
     * @summary get Electricity_Meter List
     * @operationId get_electricity_meters
     * @tags EON
     *
     * @description Get List of Electricity Meters
     *
     * @param {number} page_number - page_number is Integer. 1,2,3...n. For first call, use 1 (first page of list)
     * @param {string} body - constraints for query
     *
     * @returns {IEONElectricityMetterList} [code 200] Ok Result
     *
     * @throws {IResultInvalidBody} [code 400] Invalid body
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public electricityMeterGetList(page_number:number, body:string):Promise<IEONElectricityMetterList> {
        return this.requestRestPath("PUT", `/eon/electricity_meters/${page_number}`, body, [200]);
    }
    ...
    public eventsProduct(product_id:string, page:number, items:number):Promise<IProductEvent[]> {
        return this.requestRestPath("GET", `/product/events/${product_id}/${page}/${items}`, {}, [200]);
    }
    ...
    public fBGetLoginURL(body:IFacebookLoginRedirect):Promise<IFacebookLogin> {
        return this.requestRestPath("PUT", `/facebook/login/url`, body, [200]);
    }
    ...
    public fBGetLoginURLForPerson(body:IFacebookLoginRedirect):Promise<IFacebookLogin> {
        return this.requestRestPath("PUT", `/facebook/login/url-user`, body, [200]);
    }
     ...
     * @operationId gateway_getByFilter
     * @tags EON
     *
     * @description Get List of hardware. According to permission - system return only hardware from project, where is user owner or all hardware if user have static Permission key
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gatewayGetList(page_number:number, body:IBoardFilter):Promise<IHardwareList> {
        return this.requestRestPath("PUT", `/eon/gateway_filter/${page_number}`, body, [200]);
    }
    ...
    public hardwareGroupCreate(body:INameAndDescProjectIdRequired):Promise<IHardwareGroup> {
        return this.requestRestPath("POST", `/hardware_group`, body, [201]);
    }
    ...
    public hardwareReleaseUpdateCancel(id:string):Promise<IHardwareReleaseUpdate> {
        return this.requestRestPath("PUT", `/release_update/stop/${id}`, {}, [200]);
    }
    ...
    public hardwareReleaseUpdateGet(id:string):Promise<IHardwareReleaseUpdate> {
        return this.requestRestPath("GET", `/release_update/object/${id}`, {}, [200]);
    }
    ...
    public hardwareReleaseUpdateGetByFilter(page_number:number, body:IHardwareReleaseUpdateFilter):Promise<IHardwareReleaseUpdateList> {
        return this.requestRestPath("PUT", `/release_update/filter/${page_number}`, body, [200]);
    }
     ...
     *
     * @param {IHardwareUpdateMake} body - Contains Json with values
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareReleaseUpdateMake(body:IHardwareUpdateMake):Promise<IHardwareReleaseUpdate> {
        return this.requestRestPath("PUT", `/release_update/make`, body, [201]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareUpdate(body:IDeployFirmware):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/hardware/update/firmware`, body, [200]);
    }
    ...
    public hardwareUpdateCancel(id:string):Promise<IHardwareUpdate> {
        return this.requestRestPath("PUT", `/update_task/stop/${id}`, {}, [200]);
    }
    ...
    public hardwareUpdateGet(id:string):Promise<IHardwareUpdate> {
        return this.requestRestPath("GET", `/update_task/object/${id}`, {}, [200]);
    }
    ...
    public instanceAddApiKey(instance_id:string, body:IInstanceToken):Promise<IInstanceSnapshot> {
        return this.requestRestPath("POST", `/instance/api_key/${instance_id}`, body, [201]);
    }
    ...
    public instanceAddMeshNetworkKey(instance_id:string, body:IInstanceMesh):Promise<IInstanceSnapshot> {
        return this.requestRestPath("POST", `/instance/mesh_network_key/${instance_id}`, body, [201]);
    }
    ...
    public instanceRemoveApiKey(instance_id:string, token:string):Promise<IInstanceSnapshot> {
        return this.requestRestPath("DELETE", `/instance/api_key/${instance_id}/${token}`, {}, [200]);
    }
    ...
    public instanceRemoveMeshNetworkKey(instance_id:string, token:string):Promise<IInstanceSnapshot> {
        return this.requestRestPath("DELETE", `/instance/mesh_network_key/${instance_id}/${token}`, {}, [200]);
    }
    ...
    public instanceUpdateApiKey(instance_id:string, token:string, body:IInstanceToken):Promise<IInstanceSnapshot> {
        return this.requestRestPath("PUT", `/instance/api_key/${instance_id}/${token}`, body, [200]);
    }
    ...
    public instanceUpdateMeshNetworkKey(instance_id:string, token:string, body:IInstanceMESHEdit):Promise<IInstanceSnapshot> {
        return this.requestRestPath("PUT", `/instance/mesh_network_key/${instance_id}/${token}`, body, [200]);
    }
    ...
    public invoiceConfirm(invoice_id:string):Promise<IInvoice> {
        return this.requestRestPath("GET", `/invoice/confirm/${invoice_id}`, {}, [200]);
    }
    ...
    public invoiceSynchronizeWithFakturoid(invoice_id:string):Promise<IInvoice> {
        return this.requestRestPath("GET", `/invoice/synchronize_fakturoid/${invoice_id}`, {}, [200]);
    }
    ...
    public paymentEditDetails(payment_details_id:string, body:IPaymentDetailsUpdate):Promise<IPaymentDetails> {
        return this.requestRestPath("PUT", `/payment_details/${payment_details_id}`, body, [200]);
    }
    ...
    public permissionsGetAll():Promise<IPermission[]> {
        return this.requestRestPath("GET", `/permission/all`, {}, [200]);
    }
    ...
    public productExtensionGetListProduct(product_id:string):Promise<IProductExtension[]> {
        return this.requestRestPath("GET", `/product/extensions/${product_id}`, {}, [200]);
    }
    ...
    public productGetExtensionFinancialEvents(body:IExtensionFinancialEventSearch):Promise<IExtensionFinancialEvent[]> {
        return this.requestRestPath("POST", `/financial_events`, body, [200]);
    }
    ...
    public productGetInvoices(product_id:string):Promise<IInvoice[]> {
        return this.requestRestPath("GET", `/product/invoices/${product_id}/`, {}, [200]);
    }
    ...
    public projectValidObjectUniqueName(body:IProjectValidUniqueName):Promise<IResultOk> {
        return this.requestRestPath("POST", `/project_valid_name`, body, [200]);
    }
    ...
    public roleAddPermissions(role_id:string, body:IRoleAddPermission):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/role/permission/${role_id}`, body, [200]);
    }
    ...
    public roleAddPerson(role_id:string, body:IInvitePerson):Promise<IRole> {
        return this.requestRestPath("PUT", `/role/person/${role_id}`, body, [200]);
    }
    ...
    public roleCreate(body:INameAndDescProjectIdOptional):Promise<IRole> {
        return this.requestRestPath("POST", `/role`, body, [201]);
    }
    ...
    public roleDelete(role_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/role/${role_id}`, {}, [200]);
    }
    ...
    public roleEdit(role_id:string, body:INameAndDescription):Promise<IRole> {
        return this.requestRestPath("PUT", `/role/${role_id}`, body, [200]);
    }
    ...
    public roleGet(role_id:string):Promise<IRole> {
        return this.requestRestPath("GET", `/role/${role_id}`, {}, [200]);
    }
    ...
    public roleGetAll():Promise<IRole[]> {
        return this.requestRestPath("GET", `/role`, {}, [200]);
    }
    ...
    public roleGetListByFilter(page_number:number, body:IRoleFilter):Promise<IRoleList> {
        return this.requestRestPath("PUT", `/role/list/${page_number}`, body, [200]);
    }
    ...
    public roleRemovePermission(role_id:string, permission_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/role/permission/${role_id}/${permission_id}`, {}, [200]);
    }
    ...
    public roleRemovePerson(role_id:string, person_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/role/person/${role_id}/${person_id}`, {}, [200]);
    }
     ...
     * @tags Admin
     *
     * @description Get Tyrion Server Updates
     *
     *
     ...
     * @tags Admin
     *
     * @description Stop update proceso of this Server
     *
     *
     * @returns {IResultOk} [code 200] OK Result
     *
     ...
     * @tags Admin
     *
     * @description Update Tyrion Server
     *
    ...
    public simActivate(sim_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/gsm/active/${sim_id}`, {}, [200]);
    }
    ...
    public simDeactivate(sim_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/gsm/deactive/${sim_id}`, {}, [200]);
    }
    ...
    public simGetCrdRecords(page_number:number, body:IGSMCRDFilter):Promise<IGSMCDRList> {
        return this.requestRestPath("PUT", `/gsm/cdrs/${page_number}`, body, [200]);
    }

    /**
     * @name simGetDataUsage
     * @summary get Sim data usage
     * @operationId data_consumption
     * @tags GSM
     *
     * @param {IDataConsumptionFilter} body - Contains Json with values
     *
     * @returns {IDataSimOverview} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     * @throws {IResultFound} [code 404] Object not found
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public simGetDataUsage(body:IDataConsumptionFilter):Promise<IDataSimOverview> {
        return this.requestRestPath("PUT", `/gsm/data_consuption`, body, [200]);
    }
    ...
    public simUpdate(sim_id:string, body:IGSMUpdate):Promise<IGSM> {
        return this.requestRestPath("PUT", `/gsm/update/${sim_id}`, body, [200]);
    }
    ...
    public tariffExtensionGet(extension_id:string):Promise<ITariffExtension> {
        return this.requestRestPath("GET", `/admin/tariff_extension/${extension_id}`, {}, [200]);
    }
