...
/*                                                            */
/*   Build date: 2017-06-12 16:28:27                          */
/*   Tyrion version: 1.10.0                                   */
/*                                                            */
...
export interface IModelMProgramInstanceParameter {
    ...
    /**
     * @name snapshot_settings
     * @type ("absolutely_public"|"public_with_token"|"only_for_project_members"|"only_for_project_members_and_imitated_emails"|"not_in_instance")
     * @readonly
     * @required
     */
    snapshot_settings: ("absolutely_public"|"public_with_token"|"only_for_project_members"|"only_for_project_members_and_imitated_emails"|"not_in_instance");
    /**
...
export interface ITerminalConnectionSummary {
     ...
     * @name url
     * @type string
     * @description replaces token in URL by verified token from the other APIs if its required by query
     * @readonly
     * @required
     */
    url: string;
...
export abstract class TyrionAPI {
     ...
     *
     * @returns {ITerminalConnectionSummary} [code 200] Successfully created
     *
     * @throws {IInvalidBody} [code 400] Some Json value Missing
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IForbidden} [code 403] Need required permission
