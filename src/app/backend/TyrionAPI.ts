...
/*                                                            */
/*   Build date: 2017-03-27 17:23:03                          */
/*   Tyrion version: 1.07.8                                   */
/*                                                            */
...
export interface IBoard {
    ...
    /**
     * @name avaible_bootloader_id
     * @type string
     * @readonly
     * @required
     */
    avaible_bootloader_id: string;
    /**
     * @name avaible_bootloader_version_name
     * @type string
     * @readonly
     * @required
     */
    avaible_bootloader_version_name: string;
    /**
     * @name backup_mode
     * @type boolean
     * @required
...
export interface IBoardBackupSettings {
     ...
     * @required
     */
    board_backup_pair_list: IHardwareGroupIN[];
}
...
/**
 * @name IBoardSetBackup
 * @description: Json Model for set Backup Firmware in devices, its combination of pairs <Board_id, C_Program_version_id> 
 */
export interface IBoardSetBackup {
    /**
     * @name board_backup_pair_list
     * @type IHardwareGroupIN[]
...
export interface IBoardShortDetail {
    /**
     * @name board_online_status
     * @type boolean
     * @readonly
     * @required
     */
    board_online_status: boolean;
    /**
     * @name delete_permission
     * @type boolean
     * @readonly
...
export interface IBoardStatus {
    /**
     * @name actual_backup_c_program_id
     * @type string
     * @description Can be with null value
     * @readonly
     * @required
     */
    actual_backup_c_program_id: string;
    /**
     * @name actual_backup_c_program_name
     * @type string
     * @description Can be with null value
     * @readonly
     * @required
     */
    actual_backup_c_program_name: string;
    /**
     * @name actual_backup_c_program_version_id
     * @type string
     * @description Can be with null value
     * @readonly
     * @required
     */
    actual_backup_c_program_version_id: string;
    /**
     * @name actual_backup_c_program_version_name
     * @type string
     * @description Can be with null value
     * @readonly
     * @required
     */
    actual_backup_c_program_version_name: string;
    /**
    ...
    /**
     * @name homer_server_id
     * @type string
     * @description Can be with null value
     * @readonly
     * @required
     */
    homer_server_id: string;
    /**
     * @name instance_id
     * @type string
    ...
    instance_id: string;
    /**
     * @name instance_online_status
     * @type boolean
     * @description Only if Boar is under person Instance (in Blocko)
     * @readonly
     * @required
     */
    instance_online_status: boolean;
    /**
     * @name required_backup_c_programs
     * @type ICProgramUpdatePlanShortDetail[]
     * @description Can be empty
     * @readonly
     * @required
     */
    required_backup_c_programs: ICProgramUpdatePlanShortDetail[];
    /**
     * @name required_c_programs
     * @type ICProgramUpdatePlanShortDetail[]
     * @description Can be empty
     * @readonly
     * @required
     */
    required_c_programs: ICProgramUpdatePlanShortDetail[];
    /**
     * @name server_name
     * @type string
     * @description Can be with null value
    ...
    server_name: string;
    /**
     * @name server_online_status
     * @type boolean
     * @readonly
     * @required
     */
    server_online_status: boolean;
    /**
     * @name status
     * @type ("not_yet_first_connected"|"offline"|"online")
     * @description Can be with null value
     * @readonly
     * @required
     */
    status: ("not_yet_first_connected"|"offline"|"online");
    /**
     * @name where
     * @type ("in_person_instance"|"connected_to_server_unregistered"|"under_project_virtual_instance"|"connected_to_byzance")
     * @description Can be with null value
     * @readonly
     * @required
     */
    where: ("in_person_instance"|"connected_to_server_unregistered"|"under_project_virtual_instance"|"connected_to_byzance");
}
...
export interface IBoardsForBlocko {
    ...
    /**
     * @name c_programs
     * @type ISwaggerCProgramShortDetailForBlocko[]
     * @readonly
     * @required
     */
    c_programs: ISwaggerCProgramShortDetailForBlocko[];
    /**
     * @name m_projects
     * @type ISwaggerMProjectShortDetailForBlocko[]
     * @readonly
     * @required
     */
    m_projects: ISwaggerMProjectShortDetailForBlocko[];
    /**
     * @name type_of_boards
     * @type ITypeOfBoard[]
     * @readonly
...
export interface ICProgramVersionNew {
     ...
     * @name library_files
     * @type string[]
     * @description Contains IDs of ImportLibrary versions
     */
    library_files?: string[];
    /**
     * @name main
...
/**
 * @name IGeneralTariff
 * @description: Model of GeneralTariff
 */
export interface IGeneralTariff {
     ...
     */
    extensions_included?: IGeneralTariffExtensions[];
    /**
     * @name extensions_optional
     * @type IGeneralTariffExtensions[]
     */
    extensions_optional?: IGeneralTariffExtensions[];
    /**
     * @name id
     * @type string
     */
 ...
 * @description: Model of GeneralTariffLabel
 */
 ...
 * @description: Model of GeneralTariff_Extensions
 */
...
/**
 * @name IHardwareIN
 * @description: Interface IHardwareIN definition
 */
export interface IHardwareIN {
    /**
     * @name board_id
     * @type string
     * @required
...
/**
 * @name IImportLibrary
 * @description: Model of ImportLibrary
 */
export interface IImportLibrary {
    ...
    /**
     * @name state
     * @type ("NEW"|"TESTED"|"DEPRECATED")
     * @required
     */
    state: ("NEW"|"TESTED"|"DEPRECATED");
    /**
     * @name tag
     * @type ("AUDIO"|"MATH"|"SPI"|"WIFI"|"BLUETOOTH")
     * @required
     */
    tag: ("AUDIO"|"MATH"|"SPI"|"WIFI"|"BLUETOOTH");
    /**
     * @name type_of_boards
     * @type ITypeOfBoard[]
     */
    ...
    /**
     * @name versions
     * @type IImportLibraryVersionShortDetail[]
     */
    versions?: IImportLibraryVersionShortDetail[];
}


/**
 * @name IImportLibraryVersionShortDetail
 * @description: Json Model for ImportLibrary_Version_Short_Detail
 */
export interface IImportLibraryVersionShortDetail {
    /**
     * @name examples
...
/**
 * @name ILibraryFile
 * @description: Interface ILibraryFile definition
 */
...
export interface IPrice {
     ...
     * @name CZK
     * @type number
     * @description in Double - show CZK - Average price per month
     * @format double
     * @readonly
     * @required
     */
     ...
     * @name EUR
     * @type number
     * @description in Double - show € - Average price per month
     * @format double
     * @readonly
     * @required
     */
...
export interface IProduct {
     ...
     * @type IGeneralTariffExtensions[]
     */
    extensions?: IGeneralTariffExtensions[];
    /**
     * @name id
     * @type string
     * @required
...
export interface IProject {
    ...
    edit_permission: boolean;
    /**
     * @name get_c_program_not_deleted
     * @type ICProgram[]
     */
    get_c_program_not_deleted?: ICProgram[];
    /**
     * @name get_m_project_not_deleted
     * @type IMProject[]
     */
    get_m_project_not_deleted?: IMProject[];
    /**
     * @name id
     * @type string
     */
...
export interface IResendEmail {
     ...
     * @name mail
     * @type string
     * @description Email is voluntary Value! If is email empty, the system uses the e mail which is in registration.
     */
    mail?: string;
}
...
/**
 * @name ISwaggerCProgramShortDetailForBlocko
 * @description: Interface ISwaggerCProgramShortDetailForBlocko definition
 */
export interface ISwaggerCProgramShortDetailForBlocko {
    /**
     * @name description
     * @type string
     * @readonly
    ...
    /**
     * @name versions
     * @type ISwaggerCProgramVersionsShortDetailForBlocko[]
     * @readonly
     * @required
     */
    versions: ISwaggerCProgramVersionsShortDetailForBlocko[];
}


/**
 * @name ISwaggerCProgramVersionsShortDetailForBlocko
 * @description: Interface ISwaggerCProgramVersionsShortDetailForBlocko definition
 */
export interface ISwaggerCProgramVersionsShortDetailForBlocko {
    /**
     * @name id
     * @type string
     * @readonly
...
/**
 * @name ISwaggerMProgramShortDetailForBlocko
 * @description: Interface ISwaggerMProgramShortDetailForBlocko definition
 */
export interface ISwaggerMProgramShortDetailForBlocko {
    /**
     * @name description
     * @type string
     * @readonly
    ...
    /**
     * @name versions
     * @type ISwaggerMProgramVersionsShortDetailForBlocko[]
     * @readonly
     * @required
     */
    versions: ISwaggerMProgramVersionsShortDetailForBlocko[];
}
...
/**
 * @name ISwaggerMProgramVersionsShortDetailForBlocko
 * @description: Interface ISwaggerMProgramVersionsShortDetailForBlocko definition
 */
export interface ISwaggerMProgramVersionsShortDetailForBlocko {
    /**
     * @name id
     * @type string
     * @readonly
...
/**
 * @name ISwaggerMProjectShortDetailForBlocko
 * @description: Interface ISwaggerMProjectShortDetailForBlocko definition
 */
export interface ISwaggerMProjectShortDetailForBlocko {
    /**
     * @name description
     * @type string
     * @readonly
    ...
    /**
     * @name m_programs
     * @type ISwaggerMProgramShortDetailForBlocko[]
     * @readonly
     * @required
     */
    m_programs: ISwaggerMProgramShortDetailForBlocko[];
    /**
     * @name name
     * @type string
     * @readonly
...
export interface ITerminalConnectionSummary {
     ...
     * @name url
     * @type string
     * @description replaces token in URL by verified token from the other APIs
     * @readonly
     * @required
     */
    url: string;
...
/**
 * @name IUserFile
 * @description: Interface IUserFile definition
 */
...
export abstract class TyrionAPI {
     ...
     *
     * @param {string} return_link - this is return full url address in format  http//portal.byzance.cz/something
     *
    ...
    public __loginFacebook(return_link:string):Promise<ISocialLogin> {
        return this.requestRestPath("GET", `/facebook/${return_link}`, {}, [200]);
    }
    ...
    public __loginGitHub(return_link:string):Promise<ISocialLogin> {
        return this.requestRestPath("GET", `/github/${return_link}`, {}, [200]);
    }
     ...
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws {IObjectNotFound} [code 404] Object not found
     ...
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws {IObjectNotFound} [code 404] Objects not found - details in message
     * @throws [code 500] Server side Error
     */
     ...
     *
     */
    public createNotificationTest():Promise<IResult> {
        return this.requestRestPath("POST", `/notification/test`, {}, [200]);
    }
     ...
     * @throws {IBadRequest} [code 400] Something is wrong
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws {IObjectNotFound} [code 404] Not found object
     * @throws [code 500] Server side Error
     */
     ...
     *
     * @returns {IGoPayUrl|IProduct|IInvoice} [code 200|201|202] Created successfully - but payment is required by Credit Card|Created successfully - payment not required|Created successfully - but payment is required by Bank Transfer
     *
     * @throws {IBadRequest} [code 400] Something is wrong - details in message 
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws [code 500] Server side Error
     */
    public createProduct(body:ITariffRegister):Promise<IGoPayUrl|IProduct|IInvoice> {
        return this.requestRestPath("POST", `/product`, body, [200,201,202]);
    }
     ...
     *
     */
    public createTest():Promise<IResult> {
        return this.requestRestPath("POST", `/test`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public editBoardBackup(body:IBoardBackupSettings):Promise<IBoard> {
        return this.requestRestPath("PUT", `/board/backup`, body, [200]);
    }

    /**
     * @name editBoardBackupSetVersion
     * @summary update Board - set Backup Code
     * @operationId board_setBackupCode
     * @tags Board
     *
     * @param {IBoardSetBackup} body - Contains Json with values
     *
     * @returns {IBoard} [code 200] Ok Result
     *
     * @throws {IJsonValueMissingResult} [code 400] Some Json value Missing
     ...
     * @throws [code 500] Server side Error
     */
    public editBoardBackupSetVersion(body:IBoardSetBackup):Promise<IBoard> {
        return this.requestRestPath("PUT", `/board/backup/set_version`, body, [200]);
    }
    ...
    public editHomerServer(server_id:string, body:ICloudHomerServer):Promise<IHomerServer> {
        return this.requestRestPath("PUT", `/homer_server/${server_id}`, body, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public editProductGeneral(product_id:string, body:ISwaggerTariffGeneralEdit):Promise<IProduct> {
     ...
     * @param {string} project_id
     *
     * @returns {IInstanceShortDetail[]} [code 200] Successful Uploaded
     *
     * @throws {IBadRequest} [code 400] Something is wrong - details in message 
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws [code 500] Server side Error
     */
    public getAllInstancesForProject(project_id:string):Promise<IInstanceShortDetail[]> {
        return this.requestRestPath("GET", `/instance/project/${project_id}`, {}, [200]);
    }

    /**
     * @name getAllLibraries
     * @summary get all ImportLibraries
     * @operationId importLibrary_getAll
     * @tags ImportLibrary
     *
     * @description if you want to get all ImportLibraries.
     *
     *
     * @returns {IImportLibrary[]} [code 200] Ok Result
     *
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     * @throws {IObjectNotFound} [code 404] Objects not found
     * @throws [code 500] Server side Error
     */
    public getAllLibraries():Promise<IImportLibrary[]> {
        return this.requestRestPath("GET", `/library`, {}, [200]);
    }
     ...
     *
     * @returns {IHomerInstanceRecord} [code 200] Success
     *
     * @throws {IBadRequest} [code 400] Something is wrong - details in message 
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
    ...
    /**
     * @name getLibrary
     * @summary get ImportLibrary
     * @operationId importLibrary_get
     * @tags ImportLibrary
     *
     * @description if you want to get ImportLibrary.
     *
     ...
     * @throws [code 500] Server side Error
     */
    public getLibrary(library_id:string):Promise<IImportLibrary> {
        return this.requestRestPath("GET", `/library/${library_id}`, {}, [200]);
    }

    /**
     * @name getLibraryVersion
     * @summary get ImportLibrary Version
     * @operationId importLibraryVersion_get
     * @tags ImportLibrary
     *
     * @description get Version of ImportLibrary by query = version_id
     *
     * @param {string} version_id - version_id String query
     *
     * @returns {IImportLibraryVersionShortDetail} [code 200] Ok Result
     *
     * @throws {IBadRequest} [code 400] Something is wrong
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws [code 500] Server side Error
     */
    public getLibraryVersion(version_id:string):Promise<IImportLibraryVersionShortDetail> {
    ...
    /**
     * @name listLibraries
     * @summary get ImportLibraries by filter
     * @operationId importLibrary_getByFilter
     * @tags ImportLibrary
     *
     * @description if you want to get ImportLibraries filtered by specific tag.
     *
     ...
     * @throws [code 500] Server side Error
     */
    public listLibraries(page_number:number):Promise<IImportLibrary[]> {
        return this.requestRestPath("PUT", `/library/list/${page_number}`, {}, [200]);
    }
     ...
     *
     * @returns {ITerminalConnectionSummary} [code 200] Successful created
     *
     * @throws {IJsonValueMissingResult} [code 400] Some Json value Missing
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws [code 500] Server side Error
     */
    public putMProgramAppUrl(body:IMobileConnectionRequest):Promise<ITerminalConnectionSummary> {
