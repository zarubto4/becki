...
/*                                                            */
/*   Build date: 2018-12-16 05:03:16                          */
/*   Tyrion version: 2.2.19                                   */
/*                                                            */
...
export interface IDataSimDataGram {
     ...
     * @name date_from
     * @type string
     * @description Readable value for users
     * @required
     */
    date_from: string;
    /**
     ...
     * @name long_from
     * @type number
     * @description Represent time in millis
     * @format int64
     * @readonly
     * @required
     */
...
export interface IHardwareBatch {
    ...
    /**
     * @name server_type
     * @type ("DEVELOPER"|"STAGE"|"PRODUCTION")
     * @required
     */
    server_type: ("DEVELOPER"|"STAGE"|"PRODUCTION");
    /**
     * @name server_version
     * @type string
     * @required
...
export interface IHardwareUpdate {
    ...
    /**
     * @name state
     * @type ("IN_PLAN"|"PENDING"|"RUNNING"|"COMPLETE"|"CANCELED"|"OBSOLETE"|"FAILED")
     * @required
     */
    state: ("IN_PLAN"|"PENDING"|"RUNNING"|"COMPLETE"|"CANCELED"|"OBSOLETE"|"FAILED");
    /**
     * @name type_of_update
     * @type ("MANUALLY_BY_USER_INDIVIDUAL"|"MANUALLY_RELEASE_MANAGER"|"MANUALLY_BY_INSTANCE"|"AUTOMATICALLY_BY_INSTANCE"|"AUTOMATICALLY_BY_USER_ALWAYS_UP_TO_DATE"|"AUTOMATICALLY_BY_SERVER_ALWAYS_UP_TO_DATE")
     * @required
     */
    type_of_update: ("MANUALLY_BY_USER_INDIVIDUAL"|"MANUALLY_RELEASE_MANAGER"|"MANUALLY_BY_INSTANCE"|"AUTOMATICALLY_BY_INSTANCE"|"AUTOMATICALLY_BY_USER_ALWAYS_UP_TO_DATE"|"AUTOMATICALLY_BY_SERVER_ALWAYS_UP_TO_DATE");
    /**
     * @name update_permission
     * @type boolean
     * @description True if user can update this object.
...
export interface IHardwareUpdatesFilter {
     ...
     * @readonly
     */
    update_states?: ("IN_PLAN"|"PENDING"|"RUNNING"|"COMPLETE"|"CANCELED"|"OBSOLETE"|"FAILED")[];
    /**
     * @name update_status
     * @type ("SUCCESSFULLY_COMPLETE"|"COMPLETE"|"COMPLETE_WITH_ERROR"|"CANCELED"|"IN_PROGRESS"|"NOT_START_YET")[]
     * @readonly
...
export interface IProjectValidUniqueName {
     ...
     * @name object_id
     * @type string
     * @description Required only if there is control of some Version
     * @format uuid
     */
    object_id?: string;
    /**
     * @name object_type
     * @type ("Project"|"BProgram"|"BProgramVersion"|"CProgram"|"CProgramVersion"|"CLibrary"|"CLibraryVersion"|"GridProgram"|"GridProgramVersion"|"GridProject"|"Hardware"|"HardwareGroup"|"GSM"|"Role"|"Widget"|"WidgetVersion"|"Block"|"BlockVersion"|"Instance"|"Snapshot"|"Database"|"DatabaseCollection")
     * @description Type
     * @required
     */
    object_type: ("Project"|"BProgram"|"BProgramVersion"|"CProgram"|"CProgramVersion"|"CLibrary"|"CLibraryVersion"|"GridProgram"|"GridProgramVersion"|"GridProject"|"Hardware"|"HardwareGroup"|"GSM"|"Role"|"Widget"|"WidgetVersion"|"Block"|"BlockVersion"|"Instance"|"Snapshot"|"Database"|"DatabaseCollection");
    /**
     * @name project_id
     * @type string
     * @description Type
...
export interface ITMSimRichStatus {
    ...
    /**
     * @name activation_date_in_millis
     * @type number
     * @format int64
     * @readonly
     */
    activation_date_in_millis?: number;
    /**
     * @name balance
     * @type number
     * @format int32
    ...
    /**
     * @name expiration_date_in_millis
     * @type number
     * @format int64
     * @readonly
     */
    expiration_date_in_millis?: number;
    /**
     * @name iccid
     * @type string
     * @required
    ...
    /**
     * @name last_connection_in_millis
     * @type number
     * @format int64
     * @readonly
     */
    last_connection_in_millis?: number;
    /**
     * @name month_cost
     * @type number
     * @format double
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareReleaseUpdateCancel(task_id:string):Promise<IHardwareReleaseUpdate> {
        return this.requestRestPath("PUT", `/release_update/stop/${task_id}`, {}, [200]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareUpdateCancel(task_id:string):Promise<IHardwareUpdate> {
        return this.requestRestPath("PUT", `/update_task/stop/${task_id}`, {}, [200]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareUpdateGet(task_id:string):Promise<IHardwareUpdate> {
