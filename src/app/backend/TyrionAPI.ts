...
/*                                                            */
/*   Build date: 2018-11-11 16:45:06                          */
/*   Tyrion version: 2.2.15                                   */
/*                                                            */
...
/**
 * @name IDatabaseList
 * @description: Json Model for Database List
 */
...
export interface IHardwareType {
    /**
     * @name batches
     * @type IModelMongoHardwareBatchCollection[]
     * @description accessible only for persons with permissions
     * @readonly
     */
    batches?: IModelMongoHardwareBatchCollection[];
    /**
     * @name boot_loaders
     * @type IBootLoader[]
     * @description accessible only for persons with permissions
...
/**
 * @name IModelMongoHardwareBatchCollection
 * @description: Interface IModelMongoHardwareBatchCollection definition
 */
export interface IModelMongoHardwareBatchCollection {
    /**
     * @name assembly_manufacture_id
     * @type string
     * @required
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @param {string} product_id
     *
     * @returns {IDatabaseList} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     * @throws {IResultFound} [code 404] Object not found
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public databasesGet(product_id:string):Promise<IDatabaseList> {
     ...
     *
     * @returns {IModelMongoHardwareBatchCollection} [code 201] Successfully created
     *
     * @throws {IResultInvalidBody} [code 400] Invalid body
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareBatchCreate(hardware_type_id:string, body:IHardwareBatchNew):Promise<IModelMongoHardwareBatchCollection> {
     ...
     * @param {IHardwareBatchNew} body - Contains Json with values
     *
     * @returns {IModelMongoHardwareBatchCollection} [code 200] Ok Result
     *
     * @throws {IResultInvalidBody} [code 400] Invalid body
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareBatchEdit(batch_id:string, body:IHardwareBatchNew):Promise<IModelMongoHardwareBatchCollection> {
