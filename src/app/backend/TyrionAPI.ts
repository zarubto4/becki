...
/*                                                            */
/*   Build date: 2017-08-07 22:36:26                          */
...
export abstract class TyrionAPI {
     ...
     * @operationId customer_createCompany
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public createCompany(body:ICustomerNew):Promise<ICustomer> {
     ...
     * @operationId customer_addEmployee
     * @tags Price & Invoice & Tariffs
     *
     * @description Adds employee to a company.
     *
     * @param {string} customer_id - customer_id String query
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public createEmployee(customer_id:string, body:ICustomerEmployee):Promise<ICustomer> {
        return this.requestRestPath("POST", `/employee/${customer_id}`, body, [200]);
    }
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public createProductDetails(product_id:string, body:IPaymentDetailsNew):Promise<IPaymentDetails> {
     ...
     * @operationId customer_removeEmployee
     * @tags Price & Invoice & Tariffs
     *
     * @description Removes employee from a company.
     *
     * @param {string} employee_id - employee_id String query
     *
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public deleteEmployee(employee_id:string):Promise<IResultOk> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public editProductDetails(payment_details_id:number, body:IPaymentDetailsNew):Promise<IPaymentDetails> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public getAllCompanies():Promise<ICustomer[]> {
