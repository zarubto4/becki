...
/*                                                            */
/*   Build date: 2017-10-12 18:58:29                          */
...
export interface IActualizationProcedureFilter {
     ...
     * @required
     */
    type_of_updates: ("MANUALLY_BY_USER_INDIVIDUAL"|"MANUALLY_BY_USER_BLOCKO_GROUP"|"MANUALLY_BY_USER_BLOCKO_GROUP_ON_TIME"|"AUTOMATICALLY_BY_USER_ALWAYS_UP_TO_DATE"|"AUTOMATICALLY_BY_SERVER_ALWAYS_UP_TO_DATE")[];
}
...
/**
 * @name IBugReport
 * @description: Json Model for Bug reporting to YT
 */
...
/**
 * @name IDeviceGroupSynchco
 * @description: Interface IDeviceGroupSynchco definition
 */
export interface IDeviceGroupSynchco {
    /**
     * @name device_id
     * @type string
     * @required
...
/**
 * @name IFileLink
 * @description: Json Model with File_Link
 */
export interface IFileLink {
    /**
     * @name file_link
     * @type string
     * @description Complete URL link
     * @readonly
     * @required
     */
    file_link: string;
...
/**
 * @name IGroupDeviceSynchro
 * @description: Interface IGroupDeviceSynchro definition
 */
export interface IGroupDeviceSynchro {
    /**
     * @name device_ids
     * @type string[]
     * @required
...
export interface IHardwareGroupDeviceListEdit {
    /**
     * @name device_synchro
     * @type IDeviceGroupSynchco
     */
    device_synchro?: IDeviceGroupSynchco;
    /**
     * @name group_synchro
     * @type IGroupDeviceSynchro
     */
    group_synchro?: IGroupDeviceSynchro;
}
...
/**
 * @name ILoggyError
 * @description: Model of LoggyError
 */
export interface ILoggyError {
    /**
     * @name cause
     * @type string
     * @required
...
export abstract class TyrionAPI {
    ...
    public actualizationProcedureGetByFilter(page_number:number, body:IActualizationProcedureFilter):Promise<IActualizationProcedureList> {
        return this.requestRestPath("GET", `/actualization_procedure/filter/${page_number}`, body, [200]);
    }
     ...
     *
     * @returns {IActualizationProcedureShortDetail} [code 200] Ok Result
     *
     * @throws {INotFound} [code 400] Object not found
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IForbidden} [code 403] Need required permission
     * @throws [code 500] Server side Error
     */
    public actualizationProcedureMake(body:string):Promise<IActualizationProcedureShortDetail> {
        return this.requestRestPath("GET", `/actualization_procedure/make`, body, [200]);
    }
    ...
    /**
     * @name cProgramVersionGetBinaryDownloadLink
     * @summary get C_Program_Version Binary DownloadLink
     * @operationId cloud_file_get_c_program_version
     * @tags C_Program
     *
     ...
     *
     * @returns {IFileLink} [code 200] Ok Result
     *
     ...
     * @throws [code 500] Server side Error
     */
    public cProgramVersionGetBinaryDownloadLink(version_id:string):Promise<IFileLink> {
        return this.requestRestPath("PUT", `/c_program/version/download/${version_id}`, {}, [200]);
    }
     ...
     * @returns {IResultOk} [code 200] Ok Result
     *
     * @throws {IBadRequest} [code 400] Bad Request
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IForbidden} [code 403] Need required permission
     * @throws {INotFound} [code 404] Object not found
     * @throws {IInternalServerError} [code 500] Server side Error
     ...
     * @param {string} bug_id - bug_id String path
     *
     * @returns {ILoggyError} [code 200] OK Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {INotFound} [code 404] Object not found
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public getBug(bug_id:string):Promise<ILoggyError> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public getBugsAll():Promise<ILoggyError[]> {
     ...
     * @tags Admin-Report
     *
     * @description Reports bug to YouTrack with description.
     *
     * @param {string} bug_id - bug_id String path
     * @param {IBugReport} body - Contains Json with values
     *
     * @returns {ILoggyError} [code 200] Ok Result
     *
     * @throws {IInvalidBody} [code 400] Invalid body
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public reportBug(bug_id:string, body:IBugReport):Promise<ILoggyError> {
        return this.requestRestPath("PUT", `/admin/bug/report/${bug_id}`, body, [200]);
    }
