...
/*                                                            */
/*   Build date: 2017-08-23 20:34:49                          */
...
export interface ICProgramFilter {
     ...
     * @name public_states
     * @type string[]
     * @description Designed for Administrators for publishing decisions of Community Codes - Without permission, the value is ignored. [pending, approved, disapproved, edited]
     */
    public_states?: string[];
    /**
     * @name type_of_board_ids
     * @type string[]
