...
/*                                                            */
/*   Build date: 2017-03-15 13:08:18                          */
...
export interface ICProgramUpdatePlan {
     ...
     * @name date_of_finish
     * @type string
     * @description can be empty, which means that the procedure is not done yet. UNIX time in ms
     * @example 1466163478925
     * @format date-time
     * @required
     */
...
export interface IListOfBoards {
     ...
     * @name board_ids
     * @type string[]
     * @description Only boards where type_of_board.connectible_to_internet = true 
     * @required
     */
    board_ids: string[];
    /**
...
export abstract class TyrionAPI {
     ...
     * @throws [code 500] Server side Error
     */
    public createBlockoServer(body:ICloudHomerServer):Promise<IHomerServer> {
     ...
     * @throws [code 500] Server side Error
     */
    public editBlockoServer(server_id:string, body:ICloudHomerServer):Promise<IHomerServer> {
        return this.requestRestPath("PUT", `/blocko_server/${server_id}`, body, [200]);
    }

    /**
     * @name editBoardBackup
     * @summary update Board - update Backup settiong
     * @operationId board_update_backup
     * @tags Board
     *
     * @param {string} board_id
     ...
     * @throws [code 500] Server side Error
     */
    public editBoardBackup(board_id:string, body:IBoardBackupSettings):Promise<IBoard> {
        return this.requestRestPath("PUT", `/board/backup/${board_id}`, body, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public getAllBlockoServers():Promise<IHomerServer> {
     ...
     * @operationId board_get_for_fast_upload
     * @tags Board
     *
