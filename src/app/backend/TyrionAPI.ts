...
/*                                                            */
/*   Build date: 2018-02-20 17:43:40                          */
/*   Tyrion version: 2.0.0                                    */
/*                                                            */
...
export interface IActualizationProcedureTaskFilter {
    ...
    /**
     * @name update_states
     * @type ("COMPLETE"|"CANCELED"|"BIN_FILE_MISSING"|"NOT_YET_STARTED"|"IN_PROGRESS"|"OBSOLETE"|"NOT_UPDATED"|"WAITING_FOR_DEVICE"|"INSTANCE_INACCESSIBLE"|"HOMER_SERVER_IS_OFFLINE"|"HOMER_SERVER_NEVER_CONNECTED"|"CRITICAL_ERROR")[]
     * @readonly
     */
    update_states?: ("COMPLETE"|"CANCELED"|"BIN_FILE_MISSING"|"NOT_YET_STARTED"|"IN_PROGRESS"|"OBSOLETE"|"NOT_UPDATED"|"WAITING_FOR_DEVICE"|"INSTANCE_INACCESSIBLE"|"HOMER_SERVER_IS_OFFLINE"|"HOMER_SERVER_NEVER_CONNECTED"|"CRITICAL_ERROR")[];
    /**
     * @name update_status
 ...
 * @description: Json Model for hardware with details for fast upload
 */
...
/**
 * @name IDMBoardRegistrationCentralAuthority
 * @description: Interface IDMBoardRegistrationCentralAuthority definition
 */
export interface IDMBoardRegistrationCentralAuthority {
    /**
    ...
    full_id: string;
    /**
     * @name hardware_type_compiler_target_name
     * @type string
     * @readonly
     * @required
     */
    hardware_type_compiler_target_name: string;
    /**
...
export interface IDeployFirmware {
     ...
     * @description List of Pairs for settings of Backup C_Program Version on hardware
     * @required
     */
    hardware_pairs: IConnectedBoardIN[];
}
...
export interface IHardware {
     ...
     * @required
     */
    hardware_groups: IHardwareGroup[];
    /**
     * @name hardware_type_id
     * @type string
     * @format uuid
...
export interface IHardwareUpdate {
     ...
     * @required
     */
    state: ("COMPLETE"|"CANCELED"|"BIN_FILE_MISSING"|"NOT_YET_STARTED"|"IN_PROGRESS"|"OBSOLETE"|"NOT_UPDATED"|"WAITING_FOR_DEVICE"|"INSTANCE_INACCESSIBLE"|"HOMER_SERVER_IS_OFFLINE"|"HOMER_SERVER_NEVER_CONNECTED"|"CRITICAL_ERROR");
    /**
     * @name type_of_update
     * @type ("MANUALLY_BY_USER_INDIVIDUAL"|"MANUALLY_RELEASE_MANAGER"|"MANUALLY_BY_USER_BLOCKO_GROUP"|"MANUALLY_BY_USER_BLOCKO_GROUP_ON_TIME"|"AUTOMATICALLY_BY_USER_ALWAYS_UP_TO_DATE"|"AUTOMATICALLY_BY_SERVER_ALWAYS_UP_TO_DATE")
     * @readonly
...
export interface IInstance {
     ...
     * @required
     */
    server_online_state: ("NOT_YET_FIRST_CONNECTED"|"FREEZED"|"SHUT_DOWN"|"SYNCHRONIZATION_IN_PROGRESS"|"OFFLINE"|"ONLINE"|"UNKNOWN_LOST_CONNECTION_WITH_SERVER");
    /**
     * @name snapshots
...
export interface IMProgramInstanceParameter {
    ...
    grid_app_url: string;
    /**
     * @name grid_program_description
     * @type string
     * @readonly
     * @required
     */
    grid_program_description: string;
    /**
    ...
    /**
     * @name grid_program_name
     * @type string
     * @readonly
     * @required
     */
    grid_program_name: string;
    /**
     * @name id
     * @type string
     * @format uuid
...
export interface IWidget {
     ...
     * @name author_id
     * @type string
     * @description can be hidden, if Widget is created by Byzance or Other Company
     * @format uuid
     * @readonly
     */
    author_id?: string;
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     *
     * @param {string} block_id - block_id String path
     *
     * @returns {IResultOk} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
    ...
    /**
     * @name blockGetByFilter
     * @summary getByFilter Block
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public blockGetByFilter(page_number:number, body:IBlockFilter):Promise<IBlockoBlockList> {
     ...
     * @operationId blockVersion_makePublic
     * @tags Block
     *
     * @description sets Approval_state to pending
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public boardCheckRegistrationStatus(registration_hash:string):Promise<IBoardRegistrationStatus> {
        return this.requestRestPath("GET", `/hardware/check/${registration_hash}`, {}, [200]);
    }
    ...
    /**
     * @name boardGetRegistrationHashForByzanceAdministrators
     * @summary get Board registration hash for Byzance Administrators
     * @operationId get_registration_hardware_from_central_authority
     * @tags Garfield
     *
     * @param {string} full_id
     *
     * @returns {IDMBoardRegistrationCentralAuthority} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public boardGetRegistrationHashForByzanceAdministrators(full_id:string):Promise<IDMBoardRegistrationCentralAuthority> {
        return this.requestRestPath("GET", `/admin/garfiled_get_hardware_hash/${full_id}`, {}, [200]);
    }
    ...
    public boardSynchronizeAllWithCentralRegistrationAuthority():Promise<IResultOk> {
        return this.requestRestPath("GET", `/admin/garfiled_synchronize`, {}, [200]);
    }
     ...
     * @operationId hardware_getForFastUpload
     * @tags Hardware
     *
     * @description List of hardware under Project for fast upload of Firmware to Board from Web IDE
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public boardsGetWithFilterParameters(page_number:number, body:IBoardFilter):Promise<IHardwareList> {
     ...
     *
     * @param {string} hardware_type_id - hardware_type_id
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridProgramGetByToken(qr_token:string):Promise<ITerminalConnectionSummary> {
        return this.requestRestPath("GET", `/grid_program/app/token/${qr_token}`, {}, [200]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetMakeClone(body:IGridWidgetCopy):Promise<IWidget> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionCreate(grid_widget_id:string, body:IGridWidgetVersionNew):Promise<IWidgetVersion> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionEdit(grid_widget_version_id:string, body:INameAndDescription):Promise<IWidgetVersion> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionEditResponsePublication(body:ICommunityVersionPublishResponse):Promise<IResultOk> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionGet(grid_widget_version_id:string):Promise<IWidgetVersion> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionsGet(grid_widget_id:string, body:IGridWidgetVersionNew):Promise<IWidgetVersion[]> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareGroupGetListByFilter(page_number:number, body:IHardwareGroupFilter):Promise<IHardwareGroup[]> {
        return this.requestRestPath("GET", `/hardware_group/filter/${page_number}`, body, [200]);
    }
    ...
    public homerServersGetList(page_number:number, body:IHomerServerFilter):Promise<IHomerServerList> {
        return this.requestRestPath("GET", `/homer_server/${page_number}`, body, [200]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public instanceCreate(body:INameAndDescProjectIdRequired):Promise<IInstance> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public instanceSnapshotCreate(body:IInstanceSnapshotNew):Promise<IInstanceSnapshot> {
        return this.requestRestPath("POST", `/instance/snapshot`, body, [201]);
    }
     ...
     *
     * @param {string} snapshot_id - snapshot_id String path
     *
    ...
    public instanceSnapshotGet(snapshot_id:string):Promise<IInstanceSnapshot> {
        return this.requestRestPath("GET", `/instance/snapshot/${snapshot_id}`, {}, [200]);
    }

    /**
     * @name instanceSnapshotShutdown
     * @summary shutdown InstanceSnapshot
     * @operationId instanceSnapshot_shutdown
     * @tags Instance
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public instanceSnapshotShutdown(snapshot_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/instance/snapshot/shutdown/${snapshot_id}`, {}, [200]);
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public mProjectCreate(project_id:string, body:INameAndDescription):Promise<IGridProject> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public mProjectDelete(grid_project_id:string):Promise<IResultOk> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public mProjectEdit(grid_project_id:string, body:INameAndDescription):Promise<IGridProject> {
