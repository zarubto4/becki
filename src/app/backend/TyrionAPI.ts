...
/*                                                            */
/*   Build date: 2018-03-08 21:07:44                          */
...
export interface IBProgramVersion {
    ...
    author?: IPerson;
    /**
     * @name b_program_version_snapshots
     * @type IMProjectSnapShotDetail[]
     * @required
     */
    b_program_version_snapshots: IMProjectSnapShotDetail[];
    /**
...
export interface IMProjectSnapShotDetail {
    ...
    delete_permission: boolean;
    /**
     * @name grid_project_description
     * @type string
     * @readonly
     * @required
     */
    grid_project_description: string;
    /**
    ...
    /**
     * @name grid_project_name
     * @type string
     * @readonly
     * @required
     */
    grid_project_name: string;
    /**
     * @name id
     * @type string
     * @format uuid
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public blockGetByFilter(page_number:number, body:IBlockFilter):Promise<IBlockList> {
    ...
    /**
     * @name homerServerCreateManualy
     * @summary create Homer_Server Manualy
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public homerServerCreateManualy(body:ICloudHomerServerNewManually):Promise<IHomerServer> {
