...
/*                                                            */
/*   Build date: 2018-11-27 19:25:25                          */
/*   Tyrion version: 2.2.17                                   */
/*                                                            */
...
export interface IProjectValidUniqueName {
    ...
    /**
     * @name object_type
     * @type ("Project"|"BProgram"|"BProgramVersion"|"CProgram"|"CProgramVersion"|"CLibrary"|"CLibraryVersion"|"GridProgram"|"GridProgramVersion"|"GridProject"|"Hardware"|"HardwareGroup"|"GSM"|"Role"|"Widget"|"WidgetVersion"|"Block"|"BlockVersion"|"Instance"|"Snapshot"|"Database")
     * @description Type
     * @required
     */
    object_type: ("Project"|"BProgram"|"BProgramVersion"|"CProgram"|"CProgramVersion"|"CLibrary"|"CLibraryVersion"|"GridProgram"|"GridProgramVersion"|"GridProject"|"Hardware"|"HardwareGroup"|"GSM"|"Role"|"Widget"|"WidgetVersion"|"Block"|"BlockVersion"|"Instance"|"Snapshot"|"Database");
    /**
     * @name project_id
     * @type string
     * @description Type
...
/**
 * @name ISwaggerDatabaseCollectionList
 * @description: Interface ISwaggerDatabaseCollectionList definition
 */
export interface ISwaggerDatabaseCollectionList {
    /**
     * @name names
     * @type string[]
     * @readonly
...
export abstract class TyrionAPI extends HomerAPI {
    ...
    public cProgramUploadBinFile(body:IUploadBin):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/update_procedure/bin/uploud`, body, [200]);
    }
     ...
     * @param {string} db_id
     *
     * @returns {ISwaggerDatabaseCollectionList} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IResultForbidden} [code 403] Need required permission
     * @throws {IResultFound} [code 404] Object not found
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public collectionsGet(db_id:string):Promise<ISwaggerDatabaseCollectionList> {
    ...
    public databaseCreate(body:ISwaggerDatabaseNew):Promise<IDatabase> {
        return this.requestRestPath("PUT", `/database`, body, [201]);
    }
