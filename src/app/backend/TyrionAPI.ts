...
/*                                                            */
/*   Build date: 2019-02-04 19:59:08                          */
/*   Tyrion version: 2.3.8                                    */
/*                                                            */
...
/**
 * @name IEONElectricityMeterCreateEdit
 * @description: Json Model for getting data for EON project
 */
export interface IEONElectricityMeterCreateEdit {
    /**
     * @name description
     * @type string
     * @required
...
/**
 * @name IEONElectricityMeterFilter
 * @description: Json Model for getting data for EON project
 */
export interface IEONElectricityMeterFilter {
    /**
     * @name count_on_page
     * @type number
     * @description number of objects per page, min value is 1, max value is 50, default is 25. It's optional
...
/**
 * @name IEONDataRequest
 * @description: Json Model for getting data for EON project
 */
export interface IEONDataRequest {
    /**
     * @name end_date
     * @type number
...
export interface IEONDataValue {
    ...
    /**
     * @name data
     * @type ISwaggerEONMeasurment[]
     * @readonly
     * @required
     */
    data: ISwaggerEONMeasurment[];
}
...
/**
 * @name ISwaggerEONMeasurment
 * @description: Interface ISwaggerEONMeasurment definition
 */
export interface ISwaggerEONMeasurment {
    /**
     * @name time
     * @type number
     * @format int32
...
export abstract class TyrionAPI extends HomerAPI {
    ...
    public instanceUpdateMeshNetworkKey(instance_id:string, token:string, body:IInstanceMESHEdit):Promise<IInstanceSnapshot> {
        return this.requestRestPath("PUT", `/instance/mesh_netwhaork_key/${instance_id}/${token}`, body, [200]);
    }
    ...
    public projectGetInvitation(project_id:string):Promise<IInvitation[]> {
        return this.requestRestPath("GET", `/project/invitations/${project_id}`, {}, [200]);
    }
