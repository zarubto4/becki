...
/*                                                            */
/*   Build date: 2017-02-21 15:26:30                          */
...
export abstract class TyrionAPI {
     ...
     * @operationId board_get_for_fat_upload
     * @tags Board
     *
     ...
     * @param {string} project_id
     *
     * @returns {IBoardShortDetail[]} [code 200] Ok Result
     *
     * @throws {IJsonValueMissingResult} [code 400] Some Json value Missing
     * @throws {IResultUnauthorized} [code 401] Unauthorized request
     * @throws {IPermissionRequired} [code 403] Need required permission
     ...
     * @throws [code 500] Server side Error
     */
    public getBoardIdeHardware(project_id:string):Promise<IBoardShortDetail[]> {
     ...
     *
     */
    public sendInvoiceRemainder(invoice_id:string):Promise<IResult> {
