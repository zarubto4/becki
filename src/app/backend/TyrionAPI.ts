...
/*                                                            */
/*   Build date: 2017-07-11 10:32:26                          */
...
export interface IBProgramState {
     ...
     * @required
     */
    instance_online: ("not_yet_first_connected"|"synchronization_in_progress"|"offline"|"online"|"unknown_lost_connection_with_server");
    /**
...
export interface IBoardShortDetail {
     ...
     * @required
     */
    board_online_status: ("not_yet_first_connected"|"synchronization_in_progress"|"offline"|"online"|"unknown_lost_connection_with_server");
    /**
     * @name delete_permission
     * @type boolean
     * @readonly
     ...
     * @name last_online
     * @type number
     * @description Value is null if board_online_status is online
     * @format int64
     * @readonly
     * @required
     */
...
export interface IInstanceShortDetail {
     ...
     * @required
     */
    instance_is_online: ("not_yet_first_connected"|"synchronization_in_progress"|"offline"|"online"|"unknown_lost_connection_with_server");
    /**
     * @name name
     * @type string
     * @readonly
