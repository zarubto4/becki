...
/*                                                            */
/*   Build date: 2018-04-02 18:16:36                          */
/*   Tyrion version: 2.0.2                                    */
/*                                                            */
...
/**
 * @name IGridFilter
 * @description: Json Model for Filtering Grids Apps
 */
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     *
     * @param {number} page_number - page_number is Integer. 1,2,3...n. For first call, use 1 (first page of list)
     * @param {IGridFilter} body - Contains Json with values
     *
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridProjectGetByFilter(page_number:number, body:IGridFilter):Promise<IGridProjectList> {
        return this.requestRestPath("GET", `/grid_project/filter/${page_number}`, body, [200]);
    }
