...
/*                                                            */
/*   Build date: 2018-10-10 13:31:31                          */
 ...
 * @description: Interface IDataSimDataGram definition
 */
export interface IDataSimDataGram {
    ...
    /**
     * @name detailed_datagram
     * @type IDataSimDataGram[]
     * @required
     */
    detailed_datagram: IDataSimDataGram[];
    /**
     * @name from
     * @type number
     * @format int64
 ...
 * @description: Interface IDataSimOverview definition
 */
...
export interface IGSM {
    ...
    /**
     * @name daily_traffic_threshold_exceeded_limit
     * @type boolean
     * @required
     */
    daily_traffic_threshold_exceeded_limit: boolean;
    /**
    ...
    /**
     * @name data_overview
     * @type IDataSimOverview
     * @readonly
     */
    data_overview?: IDataSimOverview;
    /**
     * @name delete_permission
     * @type boolean
     * @description True if user can delete this object.
    ...
    /**
     * @name monthly_traffic_threshold_exceeded_limit
     * @type boolean
     * @required
     */
    monthly_traffic_threshold_exceeded_limit: boolean;
    /**
    ...
    /**
     * @name total_traffic_threshold_exceeded_limit
     * @type boolean
     * @required
     */
    total_traffic_threshold_exceeded_limit: boolean;
    /**
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public simGetCreditUsage(sim_id:string):Promise<IDataSimOverview> {
        return this.requestRestPath("PUT", `/gsm/credit/${sim_id}`, {}, [200]);
    }
