...
/*                                                            */
/*   Build date: 2017-08-28 13:04:26                          */
...
export abstract class TyrionAPI {
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productExtensionCreate(body:IProductExtensionNew):Promise<IProductExtension> {
    ...
    /**
     * @name productExtensionGetAllTypes
     * @summary get Product_Extension All types
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productExtensionGetAllTypes():Promise<IProductExtensionType[]> {
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public tariffExtensionCreate(body:IProductExtensionNew):Promise<IProductExtension> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffExtensionEdit(body:IProductExtensionNew):Promise<IProductExtension> {
    ...
    /**
     * @name tariffLabelCreate
     * @summary create Tariff_Label
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffLabelCreate(body:ISwaggerTariffLabelNew):Promise<ITariff> {
        return this.requestRestPath("POST", `/admin/label/tariff`, body, [200]);
    }

    /**
     * @name tariffLabelDelete
     * @summary delete Tariff_Label
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffLabelDelete(label_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/admin/label/${label_id}`, {}, [200]);
    }

    /**
     * @name tariffLabelEdit
     * @summary edit Tariff_Label
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffLabelEdit(body:ISwaggerTariffLabelNew):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/label`, body, [200]);
    }

    /**
     * @name tariffLabelOrderDown
     * @summary order Tariff_Label Down
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffLabelOrderDown(label_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/label/down/${label_id}`, {}, [200]);
    }

    /**
     * @name tariffLabelOrderUp
     * @summary order Tariff_Label Up
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffLabelOrderUp(label_id:string):Promise<IResultOk> {
