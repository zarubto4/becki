...
/*                                                            */
/*   Build date: 2017-05-17 18:10:42                          */
/*   Tyrion version: 1.09.2                                   */
/*                                                            */
...
export abstract class TyrionAPI {
     ...
     *
     * @throws {IJsonValueMissingResult} [code 400] Invalid body
     ...
     * @throws [code 500] Server side Error
     */
    public listLibraries(page_number:number):Promise<ILibrary[]> {
