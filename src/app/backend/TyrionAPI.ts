...
/*                                                            */
/*   Build date: 2017-08-27 17:27:17                          */
...
export interface ITypeOfBoardBatch {
    ...
    edit_permission: boolean;
    /**
     * @name get_new_MacAddress
     * @type string
     * @required
     */
    get_new_MacAddress: string;
    /**
     * @name id
     * @type string
     * @format uuid
...
export abstract class TyrionAPI {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public boardCreateAutomaticGarfield(body:IBoardNewGarfield):Promise<IBoard> {
