...
/*                                                            */
/*   Build date: 2018-02-16 20:31:41                          */
...
export interface IBProgram {
     ...
     * @required
     */
    program_versions: ILibraryVersion[];
    /**
     * @name tags
     * @type ITag[]
     * @required
...
export interface IWidget {
    ...
    /**
     * @name versions
     * @type IGridWidgetVersion[]
     * @required
     */
    versions: IGridWidgetVersion[];
}
...
export abstract class TyrionAPI extends HomerAPI {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public bProgramVersionCreate(b_program_id:string, body:IBProgramVersionNew):Promise<ILibraryVersion> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public bProgramVersionGet(version_id:string):Promise<ILibraryVersion> {
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionEdit(grid_widget_version_id:string, body:INameAndDescription):Promise<IGridWidgetVersion> {
