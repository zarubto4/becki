...
/*                                                            */
/*   Build date: 2017-08-10 19:17:17                          */
/*   Tyrion version: 1.13.4                                   */
/*                                                            */
...
export interface ICProgramUpdatePlan {
     ...
     * @name error
     * @type string
     * @description Only if state is critical_error or Homer record some error_message
     */
    error?: string;
    /**
     * @name error_code
...
/**
 * @name ICProgramVersionPublishResponse
 * @description: Json Model for admin response for publishing C_Program
 */
export interface ICProgramVersionPublishResponse {
    /**
     * @name c_program_description
     * @type string
     * @required
...
export interface ICustomerNew {
     ...
     * @type string
     * @description The company_registration_no must have at least 4 characters - FOR non-EU countries, for Business account is required registration_no OR vat_number
     */
...
export interface IGridWidgetPublishResponse {
    ...
    /**
     * @name grid_widget_design_json
     * @type string
     * @required
     */
    grid_widget_design_json: string;
    /**
     * @name grid_widget_logic_json
     * @type string
     * @required
     */
    grid_widget_logic_json: string;
    /**
...
export interface IProductExtensionNew {
     ...
     * @name count
     * @type number
     * @description For extensions 'project', 'rest_api', 'instance'. Count of projects or available requests etc.
     * @format int64
     */
    count?: number;
    /**
     ...
     * @name nonstop
     * @type boolean
     * @description For 'support' extension, if it is 24/7.
     */
    nonstop?: boolean;
    /**
     * @name product_id
...
export interface IProductNew {
     ...
     * @type boolean
     * @description If there is an existing customer with payment details, those details will be used.
     */
    default_payment_details?: boolean;
    /**
     * @name extension_ids
     * @type string[]
     ...
     * @name payment_method
     * @type ("bank_transfer"|"credit_card"|"free")
     * @description Allowable values =>[bank_transfer, credit_card], default: bank_transfer
     */
...
/**
 * @name ISwaggerTariffLabelNew
 * @description: Interface ISwaggerTariffLabelNew definition
 */
export interface ISwaggerTariffLabelNew {
    /**
     * @name description
     * @type string
     * @required
...
/**
 * @name ISwaggerTariffNew
 * @description: Interface ISwaggerTariffNew definition
 */
export interface ISwaggerTariffNew {
    /**
     * @name bank_transfer_support
     * @type boolean
     * @required
     */
...
export abstract class TyrionAPI {
    ...
    /**
     * @name actualizationGetProcedure
     ...
     */
    public actualizationGetProcedure(actualization_procedure_id:string):Promise<IActualizationProcedure> {
        return this.requestRestPath("GET", `/actualization_procedure/${actualization_procedure_id}`, {}, [200]);
    }

    /**
     * @name actualizationProcedureGetByProject
     * @summary get ActualizationProcedure by Project
     ...
     * @throws [code 500] Server side Error
     */
    public actualizationProcedureGetByProject(project_id:string):Promise<IActualizationProcedure[]> {
    ...
    /**
     * @name blockoBlockVersionEditAskForPublication
     * @summary edit BlockoBlock_Version ask for publication
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public blockoBlockVersionEditAskForPublication(blocko_block_version_id:string):Promise<IBlockoBlockVersion> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public boardConnectWithProject(hash_for_adding:string, project_id:string):Promise<IBoard> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public boardCreate(body:IBoardNew):Promise<IBoard> {
        return this.requestRestPath("POST", `/board`, body, [201]);
    }
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public boardsGetWithFilterParameters(body:IBoardFilter):Promise<IBoardList> {
     ...
     * @throws [code 500] Server side Error
     */
    public bootloaderCreate(type_of_board_id:string):Promise<IBootLoader> {
        return this.requestRestPath("POST", `/bootloader/${type_of_board_id}`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public bootloaderEdit(boot_loader_id:string):Promise<IBootLoader> {
        return this.requestRestPath("PUT", `/bootloader/${boot_loader_id}`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public bootloaderEditSetAsMain(boot_loader_id:string, body:IBoardBootloaderUpdate):Promise<IResult|IResultOk> {
        return this.requestRestPath("PUT", `/bootloader/mark/bootloader/${boot_loader_id}`, body, [200,201]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public bootloaderUploadFile(boot_loader_id:string, body:IBoardBootloaderUpdate):Promise<IResult|IResultOk> {
    ...
    /**
     * @name cProgramCreateDefaultForTypeOfBoard
     * @summary create C_Program Default for Type_Of_Board
     * @operationId c_program_createDefault
     * @tags Admin-C_Program
     *
     * @description If you want create new C_Program in project.id = {project_id}.
     *
     * @param {ICProgramNew} body - Contains Json with values
     *
     * @returns {ICProgram} [code 201] Successfully created
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public cProgramCreateDefaultForTypeOfBoard(body:ICProgramNew):Promise<ICProgram> {
        return this.requestRestPath("POST", `/c_program/create_default/scheme`, body, [201]);
    }
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public cProgramEdit(c_program_id:string, body:ICProgramNew):Promise<ICProgram> {
     ...
     * @description sets Approval_state to pending
     *
     * @param {ICProgramVersionPublishResponse} body - Contains Json with values
     *
     * @returns {IResultOk} [code 200] Ok Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public cProgramVersionEditResponsePublication(body:ICProgramVersionPublishResponse):Promise<IResultOk> {
     ...
     * @operationId fileRecord_get
     * @tags File
     *
     * @description if you want create new SingleLibrary for C_Program compilation
     *
     * @param {string} file_record_id - file_record_id String query
     *
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public fileRecordGet(file_record_id:string):Promise<IFileContent> {
        return this.requestRestPath("GET", `/file/fileRecord/${file_record_id}`, {}, [200]);
    }

    /**
     * @name forRequestDetailsNewBoard
     ...
     * @throws [code 500] Server side Error
     */
    public forRequestDetailsNewBoard(body:IHardwareNewSettingsRequest):Promise<IHardwareNewSettingsResult> {
        return this.requestRestPath("PUT", `/admin/embedded_hardware/request`, body, [200]);
    }

    /**
     * @name forResultDetailsNewBoard
     ...
     * @throws [code 500] Server side Error
     */
    public forResultDetailsNewBoard(body:IHardwareNewHardwareResult):Promise<IResultOk> {
    ...
    /**
     * @name gridWidgetVersionEditAskForPublication
     * @summary edit Grid_Widget_Version ask for publication
     ...
     * @throws [code 500] Server side Error
     */
    public gridWidgetVersionEditAskForPublication(grid_widget_version_id:string):Promise<IGridWidgetVersion> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public gridWidgetVersionEditResponsePublication(body:IGridWidgetPublishResponse):Promise<IGridWidgetVersion> {
     ...
     * @throws [code 500] Server side Error
     */
    public homerServerCreate(body:ICloudHomerServer):Promise<IHomerServer> {
     ...
     * @throws [code 500] Server side Error
     */
    public homerServerEdit(server_id:string, body:ICloudHomerServer):Promise<IHomerServer> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public instanceUpdateGridSettings(body:IInstanceGridAppSettings):Promise<IModelMProgramInstanceParameter> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public loggingTerminate(connection_id:string):Promise<IResultOk> {
     ...
     * @throws [code 500] Server side Error
     */
    public permissionAddToRole(permission_id:string, role_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/secure/role/permission/${permission_id}/${role_id}`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public permissionRemoveFromRole(permission_id:string, role_id:string):Promise<IResultOk> {
     ...
     *
     * @param {string} id - person_id String query
     *
     * @returns {IResultOk} [code 200] OK Result
     *
     * @throws {IUnauthorized} [code 401] Unauthorized request
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public personDelete(id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/person/${id}`, {}, [200]);
    }
     ...
     * @throws {IForbidden} [code 403] Need required permission
     * @throws {INotFound} [code 404] Not found object
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productActivateExtension(extension_id:string):Promise<IProductExtension> {
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productCreateExtension(body:IProductExtensionNew):Promise<IProductExtension> {
    ...
    /**
     * @name productDeactivateExtension
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productDeactivateExtension(extension_id:string):Promise<IProductExtension> {
        return this.requestRestPath("PUT", `/product_extension/deactivate/${extension_id}`, {}, [200]);
    }

    /**
     * @name productDeleteExtension
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productDeleteExtension(extension_id:string):Promise<IResultOk> {
    ...
    /**
     * @name productGetExtension
     * @summary get Product Extension
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productGetExtension(extension_id:string):Promise<IProductExtension> {
        return this.requestRestPath("GET", `/product_extension/${extension_id}`, {}, [200]);
    }

    /**
     * @name productGetExtensionListUserOwn
     * @summary get Product Extension List user Own
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productGetExtensionListUserOwn():Promise<IProductExtension[]> {
        return this.requestRestPath("GET", `/product_extension`, {}, [200]);
    }

    /**
     * @name productGetExtensionTypesAll
     * @summary get Product Extension types All
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productGetExtensionTypesAll():Promise<IProductExtensionType[]> {
        return this.requestRestPath("GET", `/product_extension/types`, {}, [200]);
    }

    /**
     * @name productUpdateExtension
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public productUpdateExtension(extension_id:string, body:IProductExtensionEdit):Promise<IProductExtension> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public projectShare(project_id:string, body:IShareProjectPerson):Promise<IProject> {
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public projectUnshare(project_id:string, body:IShareProjectPerson):Promise<IProject> {
     ...
     * @throws [code 500] Server side Error
     */
    public roleAddPerson(mail:string, role_id:string):Promise<IResultOk> {
     ...
     * @throws [code 500] Server side Error
     */
    public roleGetAll():Promise<ISecurityRole[]> {
     ...
     * @throws [code 500] Server side Error
     */
    public roleRemovePerson(person_id:string, role_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/secure/role/person/${person_id}/${role_id}`, {}, [200]);
    }
    ...
    /**
     * @name tariffActiveExtension
     * @summary active Tariff Extension
     * @operationId tariffExtension_activate
     * @tags Admin-Extension
     *
     * @description order Tariff Extension Down
     *
     * @param {string} extension_id
     *
     * @returns {IResultOk} [code 200] Ok Result
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffActiveExtension(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/extension/active/${extension_id}`, {}, [200]);
    }
     ...
     *
     * @param {ISwaggerTariffNew} body - Contains Json with values
     *
     * @returns {IResult|ITariff} [code 200|201] successful operation|Ok Result
     *
     * @throws {IBadRequest} [code 400] Something is wrong
     * @throws {IUnauthorized} [code 401] Unauthorized request
     * @throws {IForbidden} [code 403] Need required permission
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffCreate(body:ISwaggerTariffNew):Promise<IResult|ITariff> {
        return this.requestRestPath("POST", `/admin/tariff`, body, [200,201]);
    }

    /**
     * @name tariffCreateExtension
     * @summary create Tariff Extension
     ...
     * @throws {IInternalServerError} [code 500] Server side error_message
     */
    public tariffCreateExtension(body:IProductExtensionNew):Promise<IProductExtension> {
        return this.requestRestPath("POST", `/admin/extension`, body, [201]);
    }

    /**
     * @name tariffCreateLabel
     * @summary create Tariff Label
     * @operationId tariffLabel_create
     * @tags Admin-Tariff
     *
     * @description create new Tariff
     *
     * @param {ISwaggerTariffLabelNew} body - Contains Json with values
     *
     * @returns {ITariff} [code 200] Ok Result
     *
     * @throws {IBadRequest} [code 400] Something is wrong
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffCreateLabel(body:ISwaggerTariffLabelNew):Promise<ITariff> {
        return this.requestRestPath("POST", `/admin/label/tariff`, body, [200]);
    }
    ...
    /**
     * @name tariffDeactivateExtension
     * @summary deactivate Tariff Extension
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffDeactivateExtension(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/extension/deactive/${extension_id}`, {}, [200]);
    }

    /**
     * @name tariffDelete
     * @summary delete Tariff
     * @operationId tariffLabel_delete
     * @tags Admin-Tariff
     *
     * @description create new Tariff
     *
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffDelete(label_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/admin/label/${label_id}`, {}, [200]);
    }

    /**
     * @name tariffDeleteExtension
     * @summary delete Tariff Extension
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffDeleteExtension(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("DELETE", `/admin/extension/${extension_id}`, {}, [200]);
    }
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffEdit(body:ISwaggerTariffNew):Promise<ITariff> {
        return this.requestRestPath("PUT", `/admin/tariff`, body, [200]);
    }

    /**
     * @name tariffEditExtension
     * @summary edit Tariff Extension
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffEditExtension(body:IProductExtensionNew):Promise<IProductExtension> {
        return this.requestRestPath("PUT", `/admin/extension`, body, [200]);
    }

    /**
     * @name tariffEditLabel
     * @summary edit Tariff Label
     * @operationId tariffLabel_edit
     * @tags Admin-Tariff
     *
     * @description create new Tariff
     *
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffEditLabel(body:ISwaggerTariffLabelNew):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/label`, body, [200]);
    }
    ...
    /**
     * @name tariffOrderExtensionDown
     * @summary order Tariff Extension Down
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffOrderExtensionDown(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/extension/down/${extension_id}`, {}, [200]);
    }

    /**
     * @name tariffOrderExtensionUP
     * @summary order Tariff Extension UP
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffOrderExtensionUP(extension_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/extension/up/${extension_id}`, {}, [200]);
    }

    /**
     * @name tariffOrderLabelDown
     * @summary order Tariff Label Down
     * @operationId tariffLabel_down
     * @tags Admin-Tariff
     *
     * @description create new Tariff
     *
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffOrderLabelDown(label_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/label/down/${label_id}`, {}, [200]);
    }

    /**
     * @name tariffOrderLabelUp
     * @summary order Tariff Label Up
     * @operationId tariffLabel_up
     * @tags Admin-Tariff
     *
     * @description create new Tariff
     *
     ...
     * @throws {IInternalServerError} [code 500] Server side Error
     */
    public tariffOrderLabelUp(label_id:string):Promise<IResultOk> {
        return this.requestRestPath("PUT", `/admin/label/up/${label_id}`, {}, [200]);
    }
     ...
     * @summary order TypeOfBlock Down
    ...
    /**
     * @name typeOfBoardDeletePicture
     * @summary delete TypeOfBoard picture
     * @operationId typeOfBoard_removePicture
     * @tags Admin-Type-Of-Board
     *
     * @description Remove picture from TypeOfBoard
     *
     * @param {string} type_of_board_id
     *
     ...
     * @throws [code 500] Server side Error
     */
    public typeOfBoardDeletePicture(type_of_board_id:string):Promise<ITypeOfBoard> {
        return this.requestRestPath("PUT", `/typeOfBoard/picture_remove/${type_of_board_id}`, {}, [200]);
    }
     ...
     * @throws [code 500] Server side Error
     */
    public typeOfBoardUploadPicture(type_of_board_id:string, body:IBase64File):Promise<ITypeOfBoard> {
