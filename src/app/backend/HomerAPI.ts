...
/*                                                            */
/*   Build date: 2018-01-17 13:40:35                          */
...
export abstract class HomerAPI {
     ...
     *
     */
    public homerServerGetOverView():Promise<IVersionOverview> {
        return this.requestRestPath("GET", `/versions/overview`, {}, [200]);
    }
     ...
     */
    public homerServerUpdateToNewVersion(request:IUpdateServerToRequiredVersion):Promise<IResultOK> {
        return this.requestRestPath("PUT", `/versions/update_server`, request, [200]);
    }
     ...
     *
     */
    public serverServerGetListAvailableVersions():Promise<IAvailableVersion[]> {
        return this.requestRestPath("GET", `/versions/available_versions`, {}, [200]);
    }
