...
export abstract class HomerAPI {
    ...
    public homerServerGetOverView(serverURL:IHomerServer):Promise<IVersionOverview> {
        return this.requestRestPath("GET", `http://` + serverURL.server_url + (serverURL.rest_api_port !== null  ? `:` + serverURL.rest_api_port : ``)  + `/v1` + `/versions/overview`, {}, [200]);
    }
    ...
    public homerServerUpdateToNewVersion(serverURL:IHomerServer, request:IUpdateServerToRequiredVersion):Promise<IResultOK> {
        return this.requestRestPath("PUT", `http://` + serverURL.server_url + (serverURL.rest_api_port !== null  ? `:` + serverURL.rest_api_port : ``)  + `/v1` + `/versions/update_server`, request, [200]);
    }
    ...
    public serverServerGetListAvailableVersions(serverURL:IHomerServer):Promise<IAvailableVersion[]> {
        return this.requestRestPath("GET", `http://` + serverURL.server_url + (serverURL.rest_api_port !== null  ? `:` + serverURL.rest_api_port : ``)  + `/v1` + `/versions/available_versions`, {}, [200]);
    }
