        ...
        <div class="col col-lg-6 text-center pagination-centered">
            <div class="dataTables_paginate paging_bootstrap_number">
                <ul class="pagination" style="visibility: visible;">
                    ...
                    <li  class="next" [class.disabled]="(totalPages) <= selectedPage"><a title="Next" (click)="onPageClick(selectedPage+1)"><i class="fa fa-angle-right"></i></a></li>
                </ul>
            </div>
        </div>
...
export class FilterPagerComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(): void {
        ...
        this.pageList = [];
        while (this.pageList.push(i++) < this.totalPages) {};
    }
